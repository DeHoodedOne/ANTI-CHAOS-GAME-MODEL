...
OUTCOMES = ["HW", "AW", "ov6.5", "ov8.5", "ov10.5", "sh1_1.5", "sh1_2.5", "sh2_1.5", "sh2_2.5", "12"]
OUTCOMES_ALT_XLR = ["HW", "AW", "12"]

start_time = time.time()
SPORT_ = master_sport_list()[0][4]

ms_edge_path = CRITERIA[24][2]
options = EdgeOptions()
options.add_extension("_AdblockPlus.crx")
options.add_argument("start-maximized")
driver = webdriver.Edge(executable_path=ms_edge_path, options=options)

# firefox_path = CRITERIA[23][2]
...
def pts_pos_mp():
    ...
    try:
        if selected_teams_names[1].text == away_teamx:
            ...
            if first_entry > 9:
                try:
                    away_t_mp = driver.find_elements(By.CSS_SELECTOR, '[class="ui-table__row table__row--selected "] [class=" table__cell table__cell--value   "]')[3].text.strip()
                    away_nums_matches_played.append(int(away_t_mp))
                except IndexError:
                    away_nums_matches_played.append(0)
            try:
            ...
            if first_entry > 9:
                try:
                    home_t_mp = driver.find_elements(By.CSS_SELECTOR, '[class="ui-table__row table__row--selected "] [class=" table__cell table__cell--value   "]')[3].text.strip()
                    home_nums_matches_played.append(int(home_t_mp))
                except IndexError:
                    home_nums_matches_played.append(0)
            try:
...
def h2h_aggregator():
            ...
            try:
                if YEAR <= int(date___[m].text.split('.')[-1].strip()) < 90:
                    ...
                    if (int(home_score[m].text) + int(away_score[m].text)) >= 9:
                        count_8_5 += 1
                    if (int(home_score[m].text) + int(away_score[m].text)) >= 11:
                        count_10_5 += 1
    ...
    return [valid_games, count_HW, count_AW, count_6_5, count_8_5, count_10_5, count_sh1_1_5, count_sh1_2_5, count_sh2_1_5, count_sh2_2_5, count_12, count_00]


def h2h_prob_calc(h2h_probz):
    prob_HW = float(h2h_probz[1] / h2h_probz[0])
    prob_AW = float(h2h_probz[2] / h2h_probz[0])
    prob_6_5i = float(h2h_probz[3] / h2h_probz[0])
    prob_8_5i = float(h2h_probz[4] / h2h_probz[0])
    prob_10_5i = float(h2h_probz[5] / h2h_probz[0])
    prob_sh1_1_5i = float(h2h_probz[6] / h2h_probz[0])
    prob_sh1_2_5i = float(h2h_probz[7] / h2h_probz[0])
    prob_sh2_1_5i = float(h2h_probz[8] / h2h_probz[0])
    prob_sh2_2_5i = float(h2h_probz[9] / h2h_probz[0])
    prob_12i = float(h2h_probz[10] / h2h_probz[0])
    prob_00i = float(h2h_probz[11] / h2h_probz[0])

    h2h_probs = [prob_HW, prob_AW, prob_6_5i, prob_8_5i, prob_10_5i, prob_sh1_1_5i, prob_sh1_2_5i, prob_sh2_1_5i, prob_sh2_2_5i, prob_12i, prob_00i]
    probs_H2H = []
    ...
    return [probs_H2H[0], probs_H2H[1], probs_H2H[2], probs_H2H[3], probs_H2H[4], probs_H2H[5], probs_H2H[6], probs_H2H[7], probs_H2H[8], probs_H2H[9], probs_H2H[10]]


def h2h_appender(prb_HW, prb_AW, prb_6_5, prb_8_5, prb_10_5, prb_sh1_1_5, prb_sh1_2_5, prb_sh2_1_5, prb_sh2_2_5, prb_12, prb_00):
    prob_HWs.append(prb_HW)
    prob_AWs.append(prb_AW)
    prob_6_5s.append(prb_6_5)
    prob_8_5s.append(prb_8_5)
    prob_10_5s.append(prb_10_5)
...
def ht_indp_aggregator():
            ...
            try:
                if YEAR <= int(date_[k].text.split('.')[-1].strip()) < 90:
                    ...
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 0 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 0:
                        count_00_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 7 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 4:
                        count_6_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 7 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 4:
                        count_6_5_H_indp += 1
                    ...
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 9 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 6:
                        count_8_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 11 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 8:
                        count_10_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 11 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 8:
                        count_10_5_H_indp += 1
    ...
    return [valid_games_H_indp, count_HW_H_indp, count_6_5_H_indp, count_8_5_H_indp, count_10_5_H_indp, count_sh1_1_5_H_indp,
            count_sh1_2_5_H_indp, count_12_H_indp, count_00_H_indp]


def ht_indp_prob_calc(ht_probz):
    prob_HW_H_indp = float(ht_probz[1] / ht_probz[0])
    prob_AW_H_indp = 1 - prob_HW_H_indp
    prob_6_5_H_indp = float(ht_probz[2] / ht_probz[0])
    prob_8_5_H_indp = float(ht_probz[3] / ht_probz[0])
    prob_10_5_H_indp = float(ht_probz[4] / ht_probz[0])
    prob_sh1_1_5_H_indp = float(ht_probz[5] / ht_probz[0])
    prob_sh1_2_5_H_indp = float(ht_probz[6] / ht_probz[0])
    prob_sh2_1_5_H_indp = 1 - prob_sh1_1_5_H_indp
    prob_sh2_2_5_H_indp = 1 - prob_sh1_2_5_H_indp
    prob_12_H_indp = float(ht_probz[7] / ht_probz[0])
    prob_00_H_indp = float(ht_probz[8] / ht_probz[0])

    ht_indp_probs = [prob_HW_H_indp, prob_AW_H_indp, prob_6_5_H_indp, prob_8_5_H_indp, prob_10_5_H_indp, prob_sh1_1_5_H_indp,
    ...
    return [probs_HT_INDP[0], probs_HT_INDP[1], probs_HT_INDP[2], probs_HT_INDP[3], probs_HT_INDP[4], probs_HT_INDP[5],
            probs_HT_INDP[6], probs_HT_INDP[7], probs_HT_INDP[8], probs_HT_INDP[9], probs_HT_INDP[10]]


def ht_indp_appender(prb_HW_H_indp, prb_AW_H_indp, prb_6_5_H_indp, prb_8_5_H_indp, prb_10_5_H_indp, prb_sh1_1_5_H_indp,
    ...
    prob_10_5_H_indps.append(prb_10_5_H_indp)
...
def at_indp_aggregator():
            ...
            try:
                if YEAR <= int(date__[n].text.split('.')[-1].strip()) < 90:
                    ...
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 0 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 0:
                        count_00_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 7 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 4:
                        count_6_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 7 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 4:
                        count_6_5_A_indp += 1
                    ...
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 9 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 6:
                        count_8_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 11 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 8:
                        count_10_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 11 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 8:
                        count_10_5_A_indp += 1
    ...
    return [valid_games_A_indp, count_AW_A_indp, count_6_5_A_indp, count_8_5_A_indp, count_10_5_A_indp,
...
def at_indp_prob_calc(at_probz):
    ...
    prob_6_5_A_indp = float(at_probz[2] / at_probz[0])
    prob_8_5_A_indp = float(at_probz[3] / at_probz[0])
    prob_10_5_A_indp = float(at_probz[4] / at_probz[0])
    prob_sh2_1_5_A_indp = float(at_probz[5] / at_probz[0])
    prob_sh2_2_5_A_indp = float(at_probz[6] / at_probz[0])
    prob_sh1_1_5_A_indp = 1 - prob_sh2_1_5_A_indp
    prob_sh1_2_5_A_indp = 1 - prob_sh2_2_5_A_indp
    prob_12_A_indp = float(at_probz[7] / at_probz[0])
    prob_00_A_indp = float(at_probz[8] / at_probz[0])

    at_indp_probs = [prob_HW_A_indp, prob_AW_A_indp, prob_6_5_A_indp, prob_8_5_A_indp, prob_10_5_A_indp, prob_sh1_1_5_A_indp,
    ...
    return [probs_AT_INDP[0], probs_AT_INDP[1], probs_AT_INDP[2], probs_AT_INDP[3], probs_AT_INDP[4], probs_AT_INDP[5],
            probs_AT_INDP[6], probs_AT_INDP[7], probs_AT_INDP[8], probs_AT_INDP[9], probs_AT_INDP[10]]


def at_indp_appender(prb_HW_A_indp, prb_AW_A_indp, prb_6_5_A_indp, prb_8_5_A_indp, prb_10_5_A_indp, prb_sh1_1_5_A_indp,
    ...
    prob_10_5_A_indps.append(prb_10_5_A_indp)
...
def ht_g_diff_avg_aggregator():
    ...
    if len(date_) > 0:
        ...
        try:
            ...
            ht_g_diff_avgs.append(round(rdm.uniform(-6, 6), 2))
    else:
        ht_g_diff_avgs.append(round(rdm.uniform(-6, 6), 2))
...
def at_g_diff_avg_aggregator():
    ...
    if len(date__) > 0:
        ...
        try:
            ...
            at_g_diff_avgs.append(round(rdm.uniform(-6, 6), 2))
    else:
        at_g_diff_avgs.append(round(rdm.uniform(-6, 6), 2))
...
def bt_g_diff_avg_aggregator():
    ...
    if len(date___) > 0:
        ...
        try:
            ...
            bth_g_diff_avgs_x = round(rdm.uniform(-6, 6), 2)
...
def ht_g_avg_aggregator():
    ...
    if len(date_) > 0:
        ...
        try:
            ...
            ht_g_avgs.append(round(rdm.uniform(0, 10), 2))
    else:
        ht_g_avgs.append(round(rdm.uniform(0, 10), 2))
...
def at_g_avg_aggregator():
    ...
    if len(date__) > 0:
        ...
        try:
            ...
            at_g_avgs.append(round(rdm.uniform(0, 10), 2))
    else:
        at_g_avgs.append(round(rdm.uniform(0, 10), 2))
...
def bt_g_avg_aggregator():
    ...
    if len(date___) > 0:
        ...
        try:
            ...
            bth_g_avgs.append(round(rdm.uniform(0, 10), 2))
            bta_g_avgs.append(round(rdm.uniform(0, 10), 2))
    else:
        bth_g_avgs.append(round(rdm.uniform(0, 10), 2))
        bta_g_avgs.append(round(rdm.uniform(0, 10), 2))
...
def data_break_zeroes1(z, ent1):
                                    ...
                                    if prb_00_ >= prb_6_5_:
                                        while True:
                                            ...
                                            if prb_6_5_ >= prb_8_5_:
                                                while True:
                                                    prb_10_5_ = rdm.random()
                                                    if prb_8_5_ >= prb_10_5_:
                                                        h2h_appender(prb_HW=prb_HW_, prb_AW=prb_AW_, prb_6_5=prb_6_5_, prb_8_5=prb_8_5_, prb_10_5=prb_10_5_, prb_sh1_1_5=prb_sh1_1_5_,
                        ...
                        while True:
                            ...
                            if prb_00_H_indp_ >= 0.99:
                                while True:
                                    ...
                                    if prb_00_H_indp_ >= prb_6_5_H_indp_:
                                        while True:
                                            prb_8_5_H_indp_ = rdm.random()
                                            if prb_6_5_H_indp_ >= prb_8_5_H_indp_:
                                                while True:
                                                    prb_10_5_H_indp_ = rdm.random()
                                                    if prb_8_5_H_indp_ >= prb_10_5_H_indp_:
                                                        ht_indp_appender(prb_HW_H_indp=prb_HW_H_indp_, prb_AW_H_indp=prb_AW_H_indp_, prb_6_5_H_indp=prb_6_5_H_indp_, prb_8_5_H_indp=prb_8_5_H_indp_,
                                                                         prb_10_5_H_indp=prb_10_5_H_indp_, prb_sh1_1_5_H_indp=prb_sh1_1_5_H_indp_,
                        ...
                        while True:
                            ...
                            if prb_00_A_indp_ >= 0.99:
                                while True:
                                    ...
                                    if prb_00_A_indp_ >= prb_6_5_A_indp_:
                                        while True:
                                            prb_8_5_A_indp_ = rdm.random()
                                            if prb_6_5_A_indp_ >= prb_8_5_A_indp_:
                                                while True:
                                                    prb_10_5_A_indp_ = rdm.random()
                                                    if prb_8_5_A_indp_ >= prb_10_5_A_indp_:
                                                        at_indp_appender(prb_HW_A_indp=prb_HW_A_indp_, prb_AW_A_indp=prb_AW_A_indp_, prb_6_5_A_indp=prb_6_5_A_indp_, prb_8_5_A_indp=prb_8_5_A_indp_,
                                                                         prb_10_5_A_indp=prb_10_5_A_indp_, prb_sh1_1_5_A_indp=prb_sh1_1_5_A_indp_,
    ...
    bth_g_diff_avgs_z = round(rdm.uniform(-6, 6), 2)
    bta_g_diff_avgs_z = -1 * bth_g_diff_avgs_z
    home_nums_matches_played_z = rdm.randint(0, 30)
...
def odds_checker():
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    odds_augment(odds_home=_1HW, odds_away=_2AW)
                    _12S.append(rdm.choice(CONFINTVLS))
                except (NoSuchElementException, IndexError, ElementClickInterceptedException, ElementNotInteractableException):
                    _1HW = 1 / rdm.random()
                    _2AW = 1 / rdm.random()
                    odds_augment(odds_home=_1HW, odds_away=_2AW)
                    _12S.append(rdm.choice(CONFINTVLS))
        ...
        try:
            ...
            for x in range(len(ahl)):
                try:
                    id_8_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_8_5 == "8.5":
                        OVER_8_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
            ...
            for z in range(len(ahl)):
                try:
                    id_10_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_10_5 == "10.5":
                        OVER_10_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_10_5_S.append(1 / float(OVER_10_5))
                        break
                    if z == (len(ahl) - 1):
                        OVER_10_5_S.append(rdm.random())
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_10_5_S.append(rdm.random())
                        ...
                        if OVER_00 >= OVER_6_5:
                            ...
                            while True:
                                ...
                                if OVER_6_5 >= OVER_8_5:
                                    ...
                                    while True:
                                        OVER_10_5 = rdm.random()
                                        if OVER_8_5 >= OVER_10_5:
                                            OVER_10_5_S.append(OVER_10_5)
                                            break
                                    break
                            break
                    break
...
def writer(w, A, B, C, data):
    data.write(f"{countries[w]}|{leagues[w]}|{home_teams[w]}|{away_teams[w]}|{home_positions[w]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_6_5_d[w]}|{OUTCOMES[3]}:-{bayesian_8_5_d[w]}|"
               f"{OUTCOMES[4]}:-{bayesian_10_5_d[w]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[w]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[w]}|"
...
def writer1(y, F, G, H, J, data):
    data.write(f"{countries[y]}|{leagues[y]}|{home_teams[y]}|{away_teams[y]}|{home_positions[y]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_6_5_d[y]}|{OUTCOMES[3]}:-{bayesian_8_5_d[y]}|"
               f"{OUTCOMES[4]}:-{bayesian_10_5_d[y]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[y]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[y]}|"
...
def writer2(z, K, L, M, N, P, data):
    data.write(f"{countries[z]}|{leagues[z]}|{home_teams[z]}|{away_teams[z]}|{home_positions[z]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_6_5_d[z]}|{OUTCOMES[3]}:-{bayesian_8_5_d[z]}|"
               f"{OUTCOMES[4]}:-{bayesian_10_5_d[z]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[z]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[z]}|"
...
def baye_appender(baye_HW, baye_AW, baye_6_5, baye_8_5, baye_10_5, baye_sh1_1_5, baye_sh1_2_5, baye_sh2_1_5,
    ...
    bayesian_10_5_d.append(round((float(baye_10_5)), 4))
            ...
            if ht_probs[0] >= DSCRM_H_A:
                try:
                    ...
                    ht_indp_appender(prb_HW_H_indp=ht_indp_values[0], prb_AW_H_indp=ht_indp_values[1],
                                     prb_6_5_H_indp=ht_indp_values[2], prb_8_5_H_indp=ht_indp_values[3],
                                     prb_10_5_H_indp=ht_indp_values[4], prb_sh1_1_5_H_indp=ht_indp_values[5],
                                     prb_sh1_2_5_H_indp=ht_indp_values[6], prb_sh2_1_5_H_indp=ht_indp_values[7],
                                     prb_sh2_2_5_H_indp=ht_indp_values[8], prb_12_H_indp=ht_indp_values[9],
                                     prb_00_H_indp=ht_indp_values[10])
                except ZeroDivisionError:
                    ht_indp_zero()
            else:
                ht_indp_zero()
            ...
            if at_probs[0] >= DSCRM_H_A:
                try:
                    ...
                    at_indp_appender(prb_HW_A_indp=at_indp_values[0], prb_AW_A_indp=at_indp_values[1],
                                     prb_6_5_A_indp=at_indp_values[2], prb_8_5_A_indp=at_indp_values[3],
                                     prb_10_5_A_indp=at_indp_values[4], prb_sh1_1_5_A_indp=at_indp_values[5],
                                     prb_sh1_2_5_A_indp=at_indp_values[6], prb_sh2_1_5_A_indp=at_indp_values[7],
                                     prb_sh2_2_5_A_indp=at_indp_values[8], prb_12_A_indp=at_indp_values[9],
                                     prb_00_A_indp=at_indp_values[10])
                except ZeroDivisionError:
                    at_indp_zero()
            else:
                at_indp_zero()
        ...
        if len(sub3) < DSCRM_BT:
            ...
            if h2h_probs[0] >= DSCRM_BT:
                try:
                    ...
                    h2h_appender(prb_HW=h2h_values[0], prb_AW=h2h_values[1], prb_6_5=h2h_values[2], prb_8_5=h2h_values[3],
                                 prb_10_5=h2h_values[4], prb_sh1_1_5=h2h_values[5], prb_sh1_2_5=h2h_values[6],
                                 prb_sh2_1_5=h2h_values[7], prb_sh2_2_5=h2h_values[8], prb_12=h2h_values[9], prb_00=h2h_values[10])
                except ZeroDivisionError:
                    h2h_zero()
            else:
                h2h_zero()
...
def print_all_data():
    print(f"Countries: {len(countries)}, Leagues: {len(leagues)}, Home Teams: {len(home_teams)}, "
          ...
          f"Prob 6_5s: {len(prob_6_5s)}, Prob 8_5s: {len(prob_8_5s)} Prob 10_5s: {len(prob_10_5s)}, Prob 8_5s: {len(prob_sh1_1_5s)},"
          f"Prob 12s: {len(prob_12s)}, Prob HWs: {len(prob_HWs)}, Prob AWs: {len(prob_AWs)}, "
          f"Prob 6_5_H_indps: {len(prob_6_5_H_indps)}, Prob 8_5_H_indps: {len(prob_8_5_H_indps)}, Prob 10_5_H_indps: {len(prob_10_5_H_indps)}, "
          f"Prob 8_5_H_indps: {len(prob_sh1_1_5_H_indps)}, Prob 12_H_indps: {len(prob_12_H_indps)},"
          f"Prob HW_H_indps: {len(prob_HW_H_indps)}, Prob AW_H_indps: {len(prob_AW_H_indps)}, "
          f"Prob 6_5_A_indps: {len(prob_6_5_A_indps)}, Prob 8_5_A_indps: {len(prob_8_5_A_indps)}, Prob 10_5_A_indps: {len(prob_10_5_A_indps)}, "
          ...
          f"Odds _1HWS: {len(_1HWS)}, Odds _2AWS: {len(_2AWS)}, Odds OVER_6_5_S: {len(OVER_8_5_S)},  Odds OVER_8_5_S: {len(OVER_8_5_S)}, "
          f"Odds OVER_10_5_S: {len(OVER_10_5_S)}, Odds OVER_sh1_1_5_S: {len(OVER_sh1_1_5_S)}, Odds _12S: {len(_12S)}"
          f"Bayesian Home Win: {len(bayesian_home_Win_d)}, Bayesian Away Win: {len(bayesian_away_Win_d)}, "
          f"Bayesian 6_5: {len(bayesian_6_5_d)}, Bayesian 5.5: {len(bayesian_8_5_d)}, Bayesian 6.5: {len(bayesian_10_5_d)}, "
    ...
    print(f"HTGDIFF: {ht_g_diff_avgs}")
    print(f"ATGDIFF: {at_g_diff_avgs}")
    print(f"HTGDIFF: {len(ht_g_diff_avgs)}")
    print(f"ATGDIFF: {len(at_g_diff_avgs)}")
    print(f"BTHGDIFF: {bth_g_diff_avgs}")
    print(f"BTAGDIFF: {bta_g_diff_avgs}")
    print(f"BTHGDIFF: {len(bth_g_diff_avgs)}")
    print(f"BTAGDIFF: {len(bta_g_diff_avgs)}")
        ...
        with open(f"../LISTS - SPORTS DATA/SPORTS_DATA_LIST_{sport}.txt", mode="w") as file:
            try:
                file.write(f"countries = {countries}\nleagues = {leagues}\nhome_teams = {home_teams}\n"
                           ...
                           f"sport = {sport}_{i}\n_1HWS = {_1HWS}\n_2AWS = {_2AWS}\nOVER_6_5_S = {OVER_6_5_S}\n"
                           f"OVER_00_S = {OVER_00_S}\nOVER_8_5_S = {OVER_8_5_S}\nOVER_10_5_S = {OVER_10_5_S}\n"
        ...
        for COMBINER in COMBINERS[:4]:
            ...
            for COMB in COMB_PROB_METRICS1:
                ...
                for q in range(len(home_teams)):
                    try:
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                            ...
                            bayesian_10_5 = 0.5 * (rdm.random() + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                            ...
                            baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_6_5=bayesian_6_5, baye_8_5=bayesian_8_5, baye_10_5=bayesian_10_5, baye_sh1_1_5=bayesian_sh1_1_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh2_1_5=bayesian_sh2_1_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_12=bayesian_12, baye_00=bayesian_00)
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                            ...
                            bayesian_10_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_10_5 = 0.5 * (OVER_10_5_S[q] + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                            ...
                            bayesian_10_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + rdm.random())
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_10_5 = 0.5 * (OVER_10_5_S[q] + rdm.random())
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_10_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + OVER_10_5_S[q])
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[1]:
                            ...
                            bayesian_10_5 = rdm.random() * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                            ...
                            bayesian_10_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_10_5 = OVER_10_5_S[q] * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                            ...
                            bayesian_10_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * rdm.random()
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_10_5 = OVER_10_5_S[q] * rdm.random()
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_10_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * OVER_10_5_S[q]
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[2]:
                            ...
                            bayesian_10_5 = math.sqrt(0.5 * (rdm.random() + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                            ...
                            bayesian_10_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_10_5 = math.sqrt(0.5 * (OVER_10_5_S[q] + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                            ...
                            bayesian_10_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + rdm.random()))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_10_5 = math.sqrt(0.5 * (OVER_10_5_S[q] + rdm.random()))
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_10_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + OVER_10_5_S[q]))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[3]:
                            ...
                            bayesian_10_5 = math.sqrt(rdm.random() * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                            ...
                            bayesian_10_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_10_5 = math.sqrt(OVER_10_5_S[q] * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                            ...
                            bayesian_10_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * rdm.random())
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_10_5 = math.sqrt(OVER_10_5_S[q] * rdm.random())
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_10_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * OVER_10_5_S[q])
                ...
                for q in range(len(bayesian_home_Win_d)):
                    ...
                    try:
                        if bayesian_6_5_d[q] > CONFINTVL or bayesian_8_5_d[q] > CONFINTVL or bayesian_10_5_d[q] > CONFINTVL or bayesian_sh1_1_5_d[q] > CONFINTVL or bayesian_sh2_1_5_d[q] > CONFINTVL:
                                ...
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                            if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_00_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                            ...
                                            if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_00_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q] and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                if ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q])) or ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])):
                                                    with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer(w=q, A=X, B=Y, C=Z, data=file)
                            ...
                            if (home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP) and (((home_positions[q] <= away_positions[q]) and (bayesian_sh1_1_5_d[q] >= bayesian_sh2_1_5_d[q]) and (bayesian_sh1_2_5_d[q] >= bayesian_sh2_2_5_d[q]) and (bayesian_home_Win_d[q] >= bayesian_away_Win_d[q]) and (home_points[q] >= away_points[q]) and ((h_form_W[q] + h_form_D[q]) >= (a_form_W[q] + a_form_D[q])) and ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q]))) or ((home_positions[q] >= away_positions[q]) and (bayesian_home_Win_d[q] <= bayesian_away_Win_d[q]) and (bayesian_sh2_1_5_d[q] >= bayesian_sh1_1_5_d[q]) and (bayesian_sh2_2_5_d[q] >= bayesian_sh1_2_5_d[q]) and (home_points[q] <= away_points[q]) and ((h_form_W[q] + h_form_D[q]) <= (a_form_W[q] + a_form_D[q])) and ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])))):
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        ...
                                        if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_00_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer(w=q, A=X, B=Y, C=Z, data=file)
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0]:
                        ...
                        bayesian_10_5 = (prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))
                    ...
                    if X == PROB_METRICS[1]:
                        ...
                        prob_10_5 = rdm.random()
                        prob_10_5_indp_home = rdm.random()
                        prob_10_5_indp_away = rdm.random()
                        bayesian_10_5 = (prob_10_5 * (prob_10_5_indp_home * prob_10_5_indp_away)) / ((prob_10_5 * (prob_10_5_indp_home * prob_10_5_indp_away)) + ((1 - (prob_10_5_indp_home * prob_10_5_indp_away)) * (1 - prob_10_5)))
                    ...
                    if X == PROB_METRICS[2]:
                        ...
                        bayesian_10_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))
                    ...
                    if X == PROB_METRICS[4]:
                        ...
                        bayesian_10_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q])) * diff_z_prob[q]
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[1]:
                        ...
                        prob_10_5_indp_home = rdm.random()
                        prob_10_5_indp_away = rdm.random()
                        bayesian_10_5 = (prob_10_5s[q] * (prob_10_5_indp_home * prob_10_5_indp_away)) / ((prob_10_5s[q] * (prob_10_5_indp_home * prob_10_5_indp_away)) + ((1 - (prob_10_5_indp_home * prob_10_5_indp_away)) * (1 - prob_10_5s[q])))
                        prob_sh1_1_5_indp_home = rdm.random()
                        prob_sh1_1_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[2]:
                        ...
                        prob_10_5_indp_home = rdm.random()
                        prob_10_5_indp_away = rdm.random()
                        bayesian_10_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * (prob_10_5_indp_home * prob_10_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * (prob_10_5_indp_home * prob_10_5_indp_away)) + ((1 - (prob_10_5_indp_home * prob_10_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q])))))))
                        prob_sh1_1_5_indp_home = rdm.random()
                        prob_sh1_1_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[3]:
                        ...
                        prob_10_5_indp_home = rdm.random()
                        prob_10_5_indp_away = rdm.random()
                        bayesian_10_5 = (OVER_10_5_S[q] * (prob_10_5_indp_home * prob_10_5_indp_away)) / ((OVER_10_5_S[q] * (prob_10_5_indp_home * prob_10_5_indp_away)) + ((1 - (prob_10_5_indp_home * prob_10_5_indp_away)) * (1 - OVER_10_5_S[q])))
                        prob_sh1_1_5_indp_home = rdm.random()
                        prob_sh1_1_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[0]:
                        ...
                        prob_10_5 = rdm.random()
                        bayesian_10_5 = ((prob_10_5 * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5 * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5))))
                        prob_sh1_1_5 = rdm.random()
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[2]:
                        ...
                        bayesian_10_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))))))
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[3]:
                        ...
                        bayesian_10_5 = (OVER_10_5_S[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((OVER_10_5_S[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - OVER_10_5_S[q])))
                    ...
                    for q in range(len(home_teams)):
                        try:
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                                ...
                                bayesian_10_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + rdm.random() + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                                ...
                                bayesian_10_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * rdm.random() * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[4]:
                                ...
                                bayesian_10_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + rdm.random() + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_10_5 = (1 / 3) * (OVER_10_5_S[q] + rdm.random() + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_10_5 = OVER_10_5_S[q] * rdm.random() * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_10_5 = np.cbrt((1 / 3) * (OVER_10_5_S[q] + rdm.random() + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_10_5 = np.cbrt(OVER_10_5_S[q] * rdm.random() * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_10_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + OVER_10_5_S[q] + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_10_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * OVER_10_5_S[q] * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_10_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + OVER_10_5_S[q] + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_10_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * OVER_10_5_S[q] * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_10_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + rdm.random() + OVER_10_5_S[q])
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_10_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * rdm.random() * OVER_10_5_S[q]
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_10_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + rdm.random() + OVER_10_5_S[q]))
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_10_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * rdm.random() * OVER_10_5_S[q])
                                    ...
                                    if h_form_D[q] == 0 and a_form_D[q] == 0:
                                        if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                            if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                                if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_00_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                    if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                        with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                            writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                            else:
                                                if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_00_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                    if ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q])) or ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])):
                                                        with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                            writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                ...
                                if (home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP) and (((home_positions[q] <= away_positions[q]) and (bayesian_sh1_1_5_d[q] >= bayesian_sh2_1_5_d[q]) and (bayesian_sh1_2_5_d[q] >= bayesian_sh2_2_5_d[q]) and (bayesian_home_Win_d[q] >= bayesian_away_Win_d[q]) and (home_points[q] >= away_points[q]) and ((h_form_W[q] + h_form_D[q]) >= (a_form_W[q] + a_form_D[q])) and ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q]))) or ((home_positions[q] >= away_positions[q]) and (bayesian_home_Win_d[q] <= bayesian_away_Win_d[q]) and (bayesian_sh2_1_5_d[q] >= bayesian_sh1_1_5_d[q]) and (bayesian_sh2_2_5_d[q] >= bayesian_sh1_2_5_d[q]) and (home_points[q] <= away_points[q]) and ((h_form_W[q] + h_form_D[q]) <= (a_form_W[q] + a_form_D[q])) and ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])))):
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            ...
                                            if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_00_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                    if ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q])) or ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])):
                                                        with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                            writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                    ...
                    for q in range(len(home_teams)):
                        try:
                            if Z == COMBINERS[0]:
                                ...
                                bayesian_10_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + rdm.random() + OVER_10_5_S[q] + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))
                            ...
                            if Z == COMBINERS[1]:
                                ...
                                bayesian_10_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * rdm.random() * OVER_10_5_S[q] * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))
                            ...
                            if Z == COMBINERS[6]:
                                ...
                                bayesian_10_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) + rdm.random() + OVER_10_5_S[q] + ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q])))))) ** 0.25
                            ...
                            if Z == COMBINERS[7]:
                                ...
                                bayesian_10_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_10_5s[q]))) * rdm.random() * OVER_10_5_S[q] * ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) / ((prob_10_5s[q] * (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) + ((1 - (prob_10_5_H_indps[q] * prob_10_5_A_indps[q])) * (1 - prob_10_5s[q]))))) ** 0.25
