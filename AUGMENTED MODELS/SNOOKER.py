...
OUTCOMES = ["HW", "AW", "ov4.5F", "ov6.5F", "ov8.5F", "sh1_1.5", "sh1_2.5", "sh2_1.5", "sh2_2.5", "12"]
OUTCOMES_ALT_XLR = ["HW", "AW", "12"]

start_time = time.time()
SPORT_ = master_sport_list()[0][25]

# ms_edge_path = CRITERIA[24][0]
# options = EdgeOptions()
# options.add_extension("_AdblockPlus.crx")
# options.add_argument("start-maximized")
# driver = webdriver.Edge(executable_path=ms_edge_path, options=options)

# firefox_path = CRITERIA[23][0]
    ...
    try:
        ...
        if mean_ > 0 and stdv > 0:
            ...
            while True:
                ...
                away_z = rdm.random()
                draw_z = rdm.random()
                if (home_z + away_z + draw_z) <= 1:
                    home_z_prob.append(home_z)
                    away_z_prob.append(away_z)
                    draw_z_prob.append(draw_z)
...
def append_zeroes1():
    def zeroth_break(home_z_, draw_z_, away_z_, diff_z_, CLEARANCE_z):
        if 0 < home_z_ < 1 and 0 < away_z_ < 1:
            home_z_prob.append(home_z_)
            draw_z_prob.append(draw_z_)
                ...
                if diff_z < CLEARANCE_:
                    ...
                    if diff_z < CLEARANCE_:
                        ...
                        if diff_z < CLEARANCE_:
                            ...
                            draw_z = 1 - diff_z
                            if diff_z < CLEARANCE_:
                                zeroth_break(home_z_=home_z, draw_z_=draw_z, away_z_=away_z, diff_z_=diff_z, CLEARANCE_z=CLEARANCE_)
                                break
                        else:
                            zeroth_break(home_z_=home_z, draw_z_=draw_z, away_z_=away_z, diff_z_=diff_z, CLEARANCE_z=CLEARANCE_)
                            break
...
def h2h_aggregator():
            ...
            try:
                if YEAR <= int(date___[m].text.split('.')[-1].strip()) < 90:
                    ...
                    if (int(home_score[m].text) + int(away_score[m].text)) >= 0:
                        count_00 += 1
                    if (int(home_score[m].text) + int(away_score[m].text)) >= 5:
                        count_4_5 += 1
                    if (int(home_score[m].text) + int(away_score[m].text)) >= 7:
                        count_6_5 += 1
                    if (int(home_score[m].text) + int(away_score[m].text)) >= 9:
                        count_8_5 += 1
    ...
    return [valid_games, count_HW, count_X, count_AW, count_4_5, count_6_5, count_8_5, count_sh1_1_5, count_sh1_2_5,
            count_sh2_1_5, count_sh2_2_5, count_12, count_00]


def h2h_prob_calc(h2h_probz):
    prob_HW = float(h2h_probz[1] / h2h_probz[0])
    prob_Xi = float(h2h_probz[2] / h2h_probz[0])
    prob_AW = float(h2h_probz[3] / h2h_probz[0])
    prob_4_5i = float(h2h_probz[4] / h2h_probz[0])
    prob_6_5i = float(h2h_probz[5] / h2h_probz[0])
    prob_8_5i = float(h2h_probz[6] / h2h_probz[0])
    prob_sh1_1_5i = float(h2h_probz[7] / h2h_probz[0])
    prob_sh1_2_5i = float(h2h_probz[8] / h2h_probz[0])
    prob_sh2_1_5i = float(h2h_probz[9] / h2h_probz[0])
    prob_sh2_2_5i = float(h2h_probz[10] / h2h_probz[0])
    prob_12i = float(h2h_probz[11] / h2h_probz[0])
    prob_00i = float(h2h_probz[12] / h2h_probz[0])

    h2h_probs = [prob_HW, prob_Xi, prob_AW, prob_4_5i, prob_6_5i, prob_8_5i, prob_sh1_1_5i, prob_sh1_2_5i, prob_sh2_1_5i, prob_sh2_2_5i, prob_12i, prob_00i]
    probs_H2H = []
    ...
    return [probs_H2H[0], probs_H2H[1], probs_H2H[2], probs_H2H[3], probs_H2H[4], probs_H2H[5], probs_H2H[6],
            probs_H2H[7], probs_H2H[8], probs_H2H[9], probs_H2H[10], probs_H2H[11]]


def h2h_appender(prb_HW, prb_X, prb_AW, prb_4_5, prb_6_5, prb_8_5, prb_sh1_1_5, prb_sh1_2_5, prb_sh2_1_5, prb_sh2_2_5, prb_12, prb_00):
    prob_HWs.append(prb_HW)
    prob_Xs.append(prb_X)
    prob_AWs.append(prb_AW)
    prob_4_5s.append(prb_4_5)
    prob_6_5s.append(prb_6_5)
    prob_8_5s.append(prb_8_5)
...
def ht_indp_aggregator():
            ...
            try:
                if YEAR <= int(date_[k].text.split('.')[-1].strip()) < 90:
                    ...
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 0 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 0:
                        count_00_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 5 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 3:
                        count_4_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 5 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 3:
                        count_4_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 7 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 5:
                        count_6_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 7 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 5:
                        count_6_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 9 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 6:
                        count_8_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 9 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 6:
                        count_8_5_H_indp += 1
    ...
    return [valid_games_H_indp, count_HW_H_indp, count_X_H_indp, count_4_5_H_indp, count_6_5_H_indp, count_8_5_H_indp,
            count_sh1_1_5_H_indp, count_sh1_2_5_H_indp, count_12_H_indp, count_00_H_indp]


def ht_indp_prob_calc(ht_probz):
    prob_HW_H_indp = float(ht_probz[1] / ht_probz[0])
    prob_X_H_indp = float(ht_probz[2] / ht_probz[0])
    prob_AW_H_indp = 1 - prob_HW_H_indp
    prob_4_5_H_indp = float(ht_probz[3] / ht_probz[0])
    prob_6_5_H_indp = float(ht_probz[4] / ht_probz[0])
    prob_8_5_H_indp = float(ht_probz[5] / ht_probz[0])
    prob_sh1_1_5_H_indp = float(ht_probz[6] / ht_probz[0])
    prob_sh1_2_5_H_indp = float(ht_probz[7] / ht_probz[0])
    prob_sh2_1_5_H_indp = 1 - prob_sh1_1_5_H_indp
    prob_sh2_2_5_H_indp = 1 - prob_sh1_2_5_H_indp
    prob_12_H_indp = float(ht_probz[8] / ht_probz[0])
    prob_00_H_indp = float(ht_probz[9] / ht_probz[0])

    ht_indp_probs = [prob_HW_H_indp, prob_X_H_indp, prob_AW_H_indp, prob_4_5_H_indp, prob_6_5_H_indp, prob_8_5_H_indp, prob_sh1_1_5_H_indp,
    ...
    return [probs_HT_INDP[0], probs_HT_INDP[1], probs_HT_INDP[2], probs_HT_INDP[3], probs_HT_INDP[4], probs_HT_INDP[5],
            probs_HT_INDP[6], probs_HT_INDP[7], probs_HT_INDP[8], probs_HT_INDP[9], probs_HT_INDP[10], probs_HT_INDP[11]]


def ht_indp_appender(prb_HW_H_indp, prb_X_H_indp, prb_AW_H_indp, prb_4_5_H_indp, prb_6_5_H_indp, prb_8_5_H_indp, prb_sh1_1_5_H_indp,
                     prb_sh1_2_5_H_indp, prb_sh2_1_5_H_indp, prb_sh2_2_5_H_indp, prb_12_H_indp, prb_00_H_indp):
    prob_HW_H_indps.append(prb_HW_H_indp)
    prob_X_H_indps.append(prb_X_H_indp)
    prob_AW_H_indps.append(prb_AW_H_indp)
    prob_4_5_H_indps.append(prb_4_5_H_indp)
    prob_6_5_H_indps.append(prb_6_5_H_indp)
    prob_8_5_H_indps.append(prb_8_5_H_indp)
...
def at_indp_aggregator():
            ...
            try:
                if YEAR <= int(date__[n].text.split('.')[-1].strip()) < 90:
                    ...
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 0 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 0:
                        count_00_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 5 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 3:
                        count_4_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 5 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 3:
                        count_4_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 7 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 5:
                        count_6_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 7 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 5:
                        count_6_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 9 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 6:
                        count_8_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 9 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 6:
                        count_8_5_A_indp += 1
    ...
    return [valid_games_A_indp, count_AW_A_indp, count_X_A_indp, count_4_5_A_indp, count_6_5_A_indp, count_8_5_A_indp,
...
def at_indp_prob_calc(at_probz):
    ...
    prob_X_A_indp = float(at_probz[2] / at_probz[0])
    prob_HW_A_indp = 1 - prob_AW_A_indp
    prob_4_5_A_indp = float(at_probz[3] / at_probz[0])
    prob_6_5_A_indp = float(at_probz[4] / at_probz[0])
    prob_8_5_A_indp = float(at_probz[5] / at_probz[0])
    prob_sh2_1_5_A_indp = float(at_probz[6] / at_probz[0])
    prob_sh2_2_5_A_indp = float(at_probz[7] / at_probz[0])
    prob_sh1_1_5_A_indp = 1 - prob_sh2_1_5_A_indp
    prob_sh1_2_5_A_indp = 1 - prob_sh2_2_5_A_indp
    prob_12_A_indp = float(at_probz[8] / at_probz[0])
    prob_00_A_indp = float(at_probz[9] / at_probz[0])

    at_indp_probs = [prob_HW_A_indp, prob_X_A_indp, prob_AW_A_indp, prob_4_5_A_indp, prob_6_5_A_indp, prob_8_5_A_indp, prob_sh1_1_5_A_indp,
    ...
    return [probs_AT_INDP[0], probs_AT_INDP[1], probs_AT_INDP[2], probs_AT_INDP[3], probs_AT_INDP[4], probs_AT_INDP[5],
            probs_AT_INDP[6], probs_AT_INDP[7], probs_AT_INDP[8], probs_AT_INDP[9], probs_AT_INDP[10], probs_AT_INDP[11]]


def at_indp_appender(prb_HW_A_indp, prb_X_A_indp, prb_AW_A_indp, prb_4_5_A_indp, prb_6_5_A_indp, prb_8_5_A_indp, prb_sh1_1_5_A_indp,
                     prb_sh1_2_5_A_indp, prb_sh2_1_5_A_indp, prb_sh2_2_5_A_indp, prb_12_A_indp, prb_00_A_indp):
    prob_HW_A_indps.append(prb_HW_A_indp)
    prob_X_A_indps.append(prb_X_A_indp)
    prob_AW_A_indps.append(prb_AW_A_indp)
    prob_4_5_A_indps.append(prb_4_5_A_indp)
    prob_6_5_A_indps.append(prb_6_5_A_indp)
    prob_8_5_A_indps.append(prb_8_5_A_indp)
...
def ht_g_diff_avg_aggregator():
    ...
    if len(date_) > 0:
        ...
        try:
            ...
            ht_g_diff_avgs.append(round(rdm.uniform(-4, 4), 2))
    else:
        ht_g_diff_avgs.append(round(rdm.uniform(-4, 4), 2))
...
def at_g_diff_avg_aggregator():
    ...
    if len(date__) > 0:
        ...
        try:
            ...
            at_g_diff_avgs.append(round(rdm.uniform(-4, 4), 2))
    else:
        at_g_diff_avgs.append(round(rdm.uniform(-4, 4), 2))
...
def bt_g_diff_avg_aggregator():
    ...
    if len(date___) > 0:
        ...
        try:
            ...
            bth_g_diff_avgs_x = round(rdm.uniform(-4, 4), 2)
...
def ht_g_avg_aggregator():
    ...
    if len(date_) > 0:
        ...
        try:
            ...
            ht_g_avgs.append(round(rdm.uniform(0, 6), 2))
    else:
        ht_g_avgs.append(round(rdm.uniform(0, 6), 2))
...
def at_g_avg_aggregator():
    ...
    if len(date__) > 0:
        ...
        try:
            ...
            at_g_avgs.append(round(rdm.uniform(0, 6), 2))
    else:
        at_g_avgs.append(round(rdm.uniform(0, 6), 2))
...
def bt_g_avg_aggregator():
    ...
    if len(date___) > 0:
        ...
        try:
            ...
            bth_g_avgs.append(round(rdm.uniform(0, 6), 2))
            bta_g_avgs.append(round(rdm.uniform(0, 6), 2))
    else:
        bth_g_avgs.append(round(rdm.uniform(0, 6), 2))
        bta_g_avgs.append(round(rdm.uniform(0, 6), 2))
...
def data_break_zeroes1(z, ent1):
    while True:
        ...
        prb_HW_ = rdm.random()
        prb_AW_ = rdm.random()
        prb_X_ = 1 - (abs(prb_HW_ - prb_AW_))
        prb_12_ = rdm.random()
        if prb_12_ >= (prb_HW_ + prb_AW_):
            while True:
                                ...
                                if prb_00_ >= 0.99:
                                    while True:
                                        ...
                                        if prb_00_ >= prb_4_5_:
                                            while True:
                                                prb_6_5_ = rdm.random()
                                                if prb_4_5_ >= prb_6_5_:
                                                    while True:
                                                        prb_8_5_ = rdm.random()
                                                        if prb_6_5_ >= prb_8_5_:
                                                            h2h_appender(prb_HW=prb_HW_, prb_X=prb_X_, prb_AW=prb_AW_, prb_4_5=prb_4_5_,
                                                                         prb_6_5=prb_6_5_, prb_8_5=prb_8_5_, prb_sh1_1_5=prb_sh1_1_5_,
                                                                         prb_sh1_2_5=prb_sh1_2_5_, prb_sh2_1_5=prb_sh2_1_5_,
                                                                         prb_sh2_2_5=prb_sh2_2_5_, prb_12=prb_12_, prb_00=prb_00_)
                                                            break
                                                    break
                                            break
                                    break
    ...
    while True:
        ...
        prb_AW_H_indp_ = rdm.random()
        prb_X_H_indp_ = 1 - (abs(prb_HW_H_indp_ - prb_AW_H_indp_))
        prb_12_H_indp_ = rdm.random()
        if prb_12_H_indp_ >= (prb_HW_H_indp_ + prb_AW_H_indp_):
            while True:
                        ...
                        if prb_sh2_2_5_H_indp_ >= prb_sh2_1_5_H_indp_:
                            while True:
                                ...
                                if prb_00_H_indp_ >= 0.99:
                                    while True:
                                        prb_4_5_H_indp_ = rdm.random()
                                        if prb_00_H_indp_ >= prb_4_5_H_indp_:
                                            while True:
                                                prb_6_5_H_indp_ = rdm.random()
                                                if prb_4_5_H_indp_ >= prb_6_5_H_indp_:
                                                    while True:
                                                        prb_8_5_H_indp_ = rdm.random()
                                                        if prb_6_5_H_indp_ >= prb_8_5_H_indp_:
                                                            ht_indp_appender(prb_HW_H_indp=prb_HW_H_indp_, prb_X_H_indp=prb_X_H_indp_, prb_AW_H_indp=prb_AW_H_indp_,
                                                                             prb_4_5_H_indp=prb_4_5_H_indp_, prb_6_5_H_indp=prb_6_5_H_indp_,
                                                                             prb_8_5_H_indp=prb_8_5_H_indp_, prb_sh1_1_5_H_indp=prb_sh1_1_5_H_indp_,
    ...
    while True:
        ...
        prb_AW_A_indp_ = rdm.random()
        prb_X_A_indp_ = 1 - (abs(prb_HW_A_indp_ - prb_AW_A_indp_))
        prb_12_A_indp_ = rdm.random()
        if prb_12_A_indp_ >= (prb_HW_A_indp_ + prb_AW_A_indp_):
            while True:
                        ...
                        if prb_sh2_2_5_A_indp_ >= prb_sh2_1_5_A_indp_:
                            while True:
                                ...
                                if prb_00_A_indp_ >= 0.99:
                                    while True:
                                        prb_4_5_A_indp_ = rdm.random()
                                        if prb_00_A_indp_ >= prb_4_5_A_indp_:
                                            while True:
                                                prb_6_5_A_indp_ = rdm.random()
                                                if prb_4_5_A_indp_ >= prb_6_5_A_indp_:
                                                    while True:
                                                        prb_8_5_A_indp_ = rdm.random()
                                                        if prb_6_5_A_indp_ >= prb_8_5_A_indp_:
                                                            at_indp_appender(prb_HW_A_indp=prb_HW_A_indp_, prb_X_A_indp=prb_X_A_indp_, prb_AW_A_indp=prb_AW_A_indp_, prb_4_5_A_indp=prb_4_5_A_indp_, prb_6_5_A_indp=prb_6_5_A_indp_,
                                                                             prb_8_5_A_indp=prb_8_5_A_indp_, prb_sh1_1_5_A_indp=prb_sh1_1_5_A_indp_,
    ...
    bth_g_diff_avgs_z = round(rdm.uniform(-4, 4), 2)
    ...
    while True:
        ...
        if (h_form_W_z + h_form_L_z + h_form_D_z) == 1.0 and (a_form_W_z + a_form_L_z + a_form_D_z) == 1.0:
...
def home_form_checker(home_teamk):
    def h_f_zero():
        ...
        while True:
            ...
            h_form_L_z = rdm.choice(FORM_CONFIGS)
            h_form_D_z = rdm.choice(FORM_CONFIGS)
            if (h_form_W_z + h_form_L_z + h_form_D_z) == 1.0:
                h_form_W.append(h_form_W_z)
                h_form_D.append(h_form_D_z)
                h_form_L.append(h_form_L_z)
                break
...
def away_form_checker(away_teamk):
    def a_f_zero():
        ...
        while True:
            ...
            a_form_L_z = rdm.choice(FORM_CONFIGS)
            a_form_D_z = rdm.choice(FORM_CONFIGS)
            if (a_form_W_z + a_form_L_z + a_form_D_z) == 1.0:
                a_form_W.append(a_form_W_z)
                a_form_D.append(a_form_D_z)
                a_form_L.append(a_form_L_z)
                break
...
def odds_checker():
    ...
    def odds_augment(odds_home, odds_away, odds_draw):
        CLEARANCE = 0.7
        CLEARANCE_ = 0.875
        while True:
            try:
                home_aug_odd = 1 / float(odds_home)
                draw_aug_odd = 1 / float(odds_draw)
                ...
                if odds_diff < CLEARANCE:
                    ...
                    if odds_diff < CLEARANCE:
                        ...
                        draw_aug_odd = abs(1 - (home_aug_odd + away_aug_odd))
                        odds_diff = abs(home_aug_odd - away_aug_odd)
                        if odds_diff < CLEARANCE:
                                    ...
                                    if odds_diff < CLEARANCE:
                                        ...
                                        if odds_diff < CLEARANCE:
                                            ...
                                            if odds_diff < CLEARANCE:
                                                ...
                                                draw_aug_odd = 1 - odds_diff
                                                if odds_diff < CLEARANCE:
                                                    zeroth_odds_break(home_aug_odd_o=home_aug_odd, away_aug_odd_o=away_aug_odd, draw_aug_odd_o=draw_aug_odd, CLEARANCE_o=CLEARANCE)
                                                    break
                                            else:
                                                zeroth_odds_break(home_aug_odd_o=home_aug_odd, away_aug_odd_o=away_aug_odd, draw_aug_odd_o=draw_aug_odd, CLEARANCE_o=CLEARANCE)
                                                break
                    ...
                    if odds_diff < CLEARANCE_:
                        ...
                        if odds_diff < CLEARANCE_:
                            ...
                            if odds_diff < CLEARANCE_:
                                ...
                                draw_aug_odd = 1 - odds_diff
                                if odds_diff < CLEARANCE_:
                                    zeroth_odds_break(home_aug_odd_o=home_aug_odd, away_aug_odd_o=away_aug_odd, draw_aug_odd_o=draw_aug_odd, CLEARANCE_o=CLEARANCE_)
                                    break
                            else:
                                zeroth_odds_break(home_aug_odd_o=home_aug_odd, away_aug_odd_o=away_aug_odd, draw_aug_odd_o=draw_aug_odd, CLEARANCE_o=CLEARANCE_)
                                break
    ...
    try:
        ...
        try:
            ...
            _X = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .ui-table__row:nth-child(1) .oddsCell__odd')[1].text.strip()
            _2AW = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .ui-table__row:nth-child(1) .oddsCell__odd')[2].text.strip()
            odds_augment(odds_home=_1HW, odds_away=_2AW, odds_draw=_X)
            ...
            for y in range(len(ahl)):
                try:
                    ...
                    if id_sh_2_5 == "+2.5":
                        ...
                        break
                    if y == (len(ahl) - 1):
                        OVER_sh1_2_5_S.append(rdm.random())
                        OVER_sh2_2_5_S.append(rdm.random())
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_sh1_2_5_S.append(rdm.random())
        ...
        try:
            ...
            for x in range(len(ahl)):
                try:
                    id_4_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_4_5 == "4.5":
                        OVER_4_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_4_5_S.append(1 / float(OVER_4_5))
                        break
                    if x == (len(ahl) - 1):
                        OVER_4_5_S.append(rdm.random())
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_4_5_S.append(rdm.random())
            for x in range(len(ahl)):
                try:
                    id_6_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_6_5 == "6.5":
                        OVER_6_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_6_5_S.append(1 / float(OVER_6_5))
                        break
                    if x == (len(ahl) - 1):
                        OVER_6_5_S.append(rdm.random())
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_6_5_S.append(rdm.random())
            for z in range(len(ahl)):
                try:
                    id_8_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_8_5 == "8.5":
                        OVER_8_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_8_5_S.append(1 / float(OVER_8_5))
                        break
                    if z == (len(ahl) - 1):
                        OVER_8_5_S.append(rdm.random())
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_8_5_S.append(rdm.random())
            OVER_00_S.append(0.9998)
            ...
            while True:
                ...
                if OVER_00 >= 0.99:
                    ...
                    while True:
                        OVER_4_5 = rdm.random()
                        if OVER_00 >= OVER_4_5:
                            OVER_4_5_S.append(OVER_4_5)
                            while True:
                                OVER_6_5 = rdm.random()
                                if OVER_4_5 >= OVER_6_5:
                                    OVER_6_5_S.append(OVER_6_5)
                                    while True:
                                        OVER_8_5 = rdm.random()
                                        if OVER_6_5 >= OVER_8_5:
                                            OVER_8_5_S.append(OVER_8_5)
                                            break
                                    break
                            break
                    break
                ...
                if odds_diff_ < CLEARANCE__:
                    ...
                    if odds_diff_ < CLEARANCE__:
                        ...
                        if odds_diff_ < CLEARANCE__:
                            ...
                            draw_aug_odd_ = 1 - odds_diff_
                            if odds_diff_ < CLEARANCE__:
                                zeroth_odds_break(home_aug_odd_o=home_aug_odd_, away_aug_odd_o=away_aug_odd_, draw_aug_odd_o=draw_aug_odd_, CLEARANCE_o=CLEARANCE__)
                                break
                        else:
                            zeroth_odds_break(home_aug_odd_o=home_aug_odd_, away_aug_odd_o=away_aug_odd_, draw_aug_odd_o=draw_aug_odd_, CLEARANCE_o=CLEARANCE__)
                            break
...
def writer(w, A, B, C, data):
    data.write(f"{countries[w]}|{leagues[w]}|{home_teams[w]}|{away_teams[w]}|{home_positions[w]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_4_5_d[w]}|{OUTCOMES[3]}:-{bayesian_6_5_d[w]}|"
               f"{OUTCOMES[4]}:-{bayesian_8_5_d[w]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[w]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[w]}|"
               f"{OUTCOMES[7]}:-{bayesian_sh2_1_5_d[w]}|{OUTCOMES[8]}:-{bayesian_sh2_2_5_d[w]}|{OUTCOMES[9]}:-{bayesian_12_d[w]}|"
...
def writer1(y, F, G, H, J, data):
    data.write(f"{countries[y]}|{leagues[y]}|{home_teams[y]}|{away_teams[y]}|{home_positions[y]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_4_5_d[y]}|{OUTCOMES[3]}:-{bayesian_6_5_d[y]}|"
               f"{OUTCOMES[4]}:-{bayesian_8_5_d[y]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[y]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[y]}|"
               f"{OUTCOMES[7]}:-{bayesian_sh2_1_5_d[y]}|{OUTCOMES[8]}:-{bayesian_sh2_2_5_d[y]}|{OUTCOMES[9]}:-{bayesian_12_d[y]}|"
...
def writer2(z, K, L, M, N, P, data):
    data.write(f"{countries[z]}|{leagues[z]}|{home_teams[z]}|{away_teams[z]}|{home_positions[z]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_4_5_d[z]}|{OUTCOMES[3]}:-{bayesian_6_5_d[z]}|"
               f"{OUTCOMES[4]}:-{bayesian_8_5_d[z]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[z]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[z]}|"
               f"{OUTCOMES[7]}:-{bayesian_sh2_1_5_d[z]}|{OUTCOMES[8]}:-{bayesian_sh2_2_5_d[z]}|{OUTCOMES[9]}:-{bayesian_12_d[z]}|"
               f"{match_times[z]}|{sport}|{P}_{K}_{L}_{M}_{N}|{set_date_s_size()[0]}\n")


def baye_appender(baye_HW, baye_AW, baye_4_5, baye_6_5, baye_8_5, baye_sh1_1_5, baye_sh1_2_5, baye_sh2_1_5,
    ...
    bayesian_4_5_d.append(round((float(baye_4_5)), 4))
    bayesian_6_5_d.append(round((float(baye_6_5)), 4))
    bayesian_8_5_d.append(round((float(baye_8_5)), 4))
...
def writer_draw(w, A, B, C, data):
    data.write(f"{countries[w]}|{leagues[w]}|{home_teams[w]}|{away_teams[w]}|{home_positions[w]}|"
               f"{away_positions[w]}|{home_nums_matches_played[w]}|{away_nums_matches_played[w]}|{home_points[w]}|"
               f"{away_points[w]}|{h_form_W[w]}|{h_form_D[w]}|{h_form_L[w]}|{a_form_W[w]}|{a_form_D[w]}|{a_form_L[w]}|"
               f"{ht_g_avgs[w]}|{at_g_avgs[w]}|{bth_g_avgs[w]}|{bta_g_avgs[w]}|{ht_g_diff_avgs[w]}|{at_g_diff_avgs[w]}|{bth_g_diff_avgs[w]}|{bta_g_diff_avgs[w]}|"
               f"{OUTCOMES_DRAW[0]}:-{bayesian_home_Win_d[w]}|{OUTCOMES_DRAW[1]}:-{bayesian_X_d[w]}|{OUTCOMES_DRAW[2]}:-{bayesian_away_Win_d[w]}|"
               f"{OUTCOMES_DRAW[3]}:-{bayesian_12_d[w]}|"
               f"{match_times[w]}|{sport}|{C}_{A}_{B}|{set_date_s_size()[0]}\n")


def writer_draw1(y, F, G, H, J, data):
    data.write(f"{countries[y]}|{leagues[y]}|{home_teams[y]}|{away_teams[y]}|{home_positions[y]}|"
               f"{away_positions[y]}|{home_nums_matches_played[y]}|{away_nums_matches_played[y]}|{home_points[y]}|"
               f"{away_points[y]}|{h_form_W[y]}|{h_form_D[y]}|{h_form_L[y]}|{a_form_W[y]}|{a_form_D[y]}|{a_form_L[y]}|"
               f"{ht_g_avgs[y]}|{at_g_avgs[y]}|{bth_g_avgs[y]}|{bta_g_avgs[y]}|{ht_g_diff_avgs[y]}|{at_g_diff_avgs[y]}|{bth_g_diff_avgs[y]}|{bta_g_diff_avgs[y]}|"
               f"{OUTCOMES_DRAW[0]}:-{bayesian_home_Win_d[y]}|{OUTCOMES_DRAW[1]}:-{bayesian_X_d[y]}|{OUTCOMES_DRAW[2]}:-{bayesian_away_Win_d[y]}|"
               f"{OUTCOMES_DRAW[3]}:-{bayesian_12_d[y]}|"
               f"{match_times[y]}|{sport}|{J}_{F}_{G}_{H}|{set_date_s_size()[0]}\n")


def writer_draw2(z, K, L, M, N, P, data):
    data.write(f"{countries[z]}|{leagues[z]}|{home_teams[z]}|{away_teams[z]}|{home_positions[z]}|"
               f"{away_positions[z]}|{home_nums_matches_played[z]}|{away_nums_matches_played[z]}|{home_points[z]}|"
               f"{away_points[z]}|{h_form_W[z]}|{h_form_D[z]}|{h_form_L[z]}|{a_form_W[z]}|{a_form_D[z]}|{a_form_L[z]}|"
               f"{ht_g_avgs[z]}|{at_g_avgs[z]}|{bth_g_avgs[z]}|{bta_g_avgs[z]}|{ht_g_diff_avgs[z]}|{at_g_diff_avgs[z]}|{bth_g_diff_avgs[z]}|{bta_g_diff_avgs[z]}|"
               f"{OUTCOMES_DRAW[0]}:-{bayesian_home_Win_d[z]}|{OUTCOMES_DRAW[1]}:-{bayesian_X_d[z]}|{OUTCOMES_DRAW[2]}:-{bayesian_away_Win_d[z]}|"
               f"{OUTCOMES_DRAW[3]}:-{bayesian_12_d[z]}|"
               f"{match_times[z]}|{sport}|{P}_{K}_{L}_{M}_{N}|{set_date_s_size()[0]}\n")


def baye_appender_draw(baye_HW, baye_X, baye_AW, baye_12):
    bayesian_home_Win_d.append(round((float(baye_HW)), 4))
    bayesian_X_d.append(round((float(baye_X)), 4))
    bayesian_away_Win_d.append(round((float(baye_AW)), 4))
    bayesian_12_d.append(round((float(baye_12)), 4))
        ...
        if len(sub1) < DSCRM_H_A:
            ...
            if ht_probs[0] >= DSCRM_H_A:
                try:
                    ...
                    ht_indp_appender(prb_HW_H_indp=ht_indp_values[0], prb_X_H_indp=ht_indp_values[1], prb_AW_H_indp=ht_indp_values[2],
                                     prb_4_5_H_indp=ht_indp_values[3], prb_6_5_H_indp=ht_indp_values[4],
                                     prb_8_5_H_indp=ht_indp_values[5], prb_sh1_1_5_H_indp=ht_indp_values[6],
                                     prb_sh1_2_5_H_indp=ht_indp_values[7], prb_sh2_1_5_H_indp=ht_indp_values[8],
                                     prb_sh2_2_5_H_indp=ht_indp_values[9], prb_12_H_indp=ht_indp_values[10], prb_00_H_indp=ht_indp_values[11])
                except ZeroDivisionError:
                    ht_indp_zero()
            else:
                ht_indp_zero()
        ...
        if len(sub2) < DSCRM_H_A:
            ...
            if at_probs[0] >= DSCRM_H_A:
                try:
                    ...
                    at_indp_appender(prb_HW_A_indp=at_indp_values[0], prb_X_A_indp=at_indp_values[1], prb_AW_A_indp=at_indp_values[2],
                                     prb_4_5_A_indp=at_indp_values[3], prb_6_5_A_indp=at_indp_values[4],
                                     prb_8_5_A_indp=at_indp_values[5], prb_sh1_1_5_A_indp=at_indp_values[6],
                                     prb_sh1_2_5_A_indp=at_indp_values[7], prb_sh2_1_5_A_indp=at_indp_values[8],
                                     prb_sh2_2_5_A_indp=at_indp_values[9], prb_12_A_indp=at_indp_values[10], prb_00_A_indp=at_indp_values[11])
                except ZeroDivisionError:
                    at_indp_zero()
            else:
                at_indp_zero()
        ...
        if len(sub3) < DSCRM_BT:
            ...
            if h2h_probs[0] >= DSCRM_BT:
                try:
                    ...
                    h2h_appender(prb_HW=h2h_values[0], prb_X=h2h_values[1], prb_AW=h2h_values[2], prb_4_5=h2h_values[3], prb_6_5=h2h_values[4],
                                 prb_8_5=h2h_values[5], prb_sh1_1_5=h2h_values[6], prb_sh1_2_5=h2h_values[7],
                                 prb_sh2_1_5=h2h_values[8], prb_sh2_2_5=h2h_values[9], prb_12=h2h_values[10], prb_00=h2h_values[11])
                except ZeroDivisionError:
                    h2h_zero()
            else:
                h2h_zero()
...
def print_all_data():
    print(f"Countries: {len(countries)}, Leagues: {len(leagues)}, Home Teams: {len(home_teams)}, "
          ...
          f"Prob 4_5s: {len(prob_4_5s)}, Prob 6_5s: {len(prob_6_5s)} Prob 8_5s: {len(prob_8_5s)}, Prob 7_5s: {len(prob_sh1_1_5s)},"
          f"Prob 12s: {len(prob_12s)}, Prob HWs: {len(prob_HWs)}, Prob AWs: {len(prob_AWs)}, "
          f"Prob 4_5_H_indps: {len(prob_4_5_H_indps)}, Prob 6_5_H_indps: {len(prob_6_5_H_indps)}, Prob 8_5_H_indps: {len(prob_8_5_H_indps)}, "
          f"Prob 7_5_H_indps: {len(prob_sh1_1_5_H_indps)}, Prob 12_H_indps: {len(prob_12_H_indps)},"
          f"Prob HW_H_indps: {len(prob_HW_H_indps)}, Prob AW_H_indps: {len(prob_AW_H_indps)}, "
          f"Prob 3_5_A_indps: {len(prob_4_5_A_indps)}, Prob 7_5_A_indps: {len(prob_6_5_A_indps)}, Prob 8_5_A_indps: {len(prob_8_5_A_indps)}, "
          ...
          f"Odds _1HWS: {len(_1HWS)}, Odds _2AWS: {len(_2AWS)}, Odds OVER_4_5_S: {len(OVER_6_5_S)},  Odds OVER_6_5_S: {len(OVER_6_5_S)}, "
          f"Odds OVER_8_5_S: {len(OVER_8_5_S)}, Odds OVER_sh1_1_5_S: {len(OVER_sh1_1_5_S)}, Odds _12S: {len(_12S)}"
          f"Bayesian Home Win: {len(bayesian_home_Win_d)}, Bayesian Away Win: {len(bayesian_away_Win_d)}, "
          f"Bayesian 3_5: {len(bayesian_4_5_d)}, Bayesian 5.5: {len(bayesian_6_5_d)}, Bayesian 6.5: {len(bayesian_8_5_d)}, "
        ...
        with open(f"../LISTS - SPORTS DATA/SPORTS_DATA_LIST_{sport}.txt", mode="w") as file:
            try:
                file.write(f"countries = {countries}\nleagues = {leagues}\nhome_teams = {home_teams}\n"
                           ...
                           f"prob_12s = {prob_12s}\nprob_HWs = {prob_HWs}\nprob_AWs = {prob_AWs}\n"
                           f"prob_00_H_indps = {prob_00_H_indps}\nprob_4_5_H_indps = {prob_4_5_H_indps}\nprob_6_5_H_indps = {prob_6_5_H_indps}\nprob_8_5_H_indps = {prob_8_5_H_indps}\n"
                           ...
                           f"prob_00_A_indps = {prob_00_A_indps}\nprob_4_5_A_indps = {prob_4_5_A_indps}\nprob_6_5_A_indps = {prob_6_5_A_indps}\nprob_8_5_A_indps = {prob_8_5_A_indps}\n"
                           ...
                           f"prob_12_A_indps = {prob_12_A_indps}\nprob_Xs = {prob_Xs}\nprob_X_H_indps = {prob_X_H_indps}\nprob_X_A_indps = {prob_X_A_indps}\ndraw_z_prob = {draw_z_prob}\n_XS = {_XS}\n"
                           ...
                           f"sport = '{sport}_{i}'\n_1HWS = {_1HWS}\n_2AWS = {_2AWS}\nOVER_00_S = {OVER_00_S}\nOVER_4_5_S = {OVER_4_5_S}\n"
                           f"OVER_6_5_S = {OVER_6_5_S}\nOVER_8_5_S = {OVER_8_5_S}\n"
        ...
        for COMBINER in COMBINERS[:4]:
            ...
            for COMB in COMB_PROB_METRICS1:
                ...
                for q in range(len(home_teams)):
                    try:
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                            ...
                            bayesian_4_5 = 0.5 * (rdm.random() + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                            bayesian_6_5 = 0.5 * (rdm.random() + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                            bayesian_8_5 = 0.5 * (rdm.random() + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                            ...
                            baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_4_5=bayesian_4_5, baye_6_5=bayesian_6_5, baye_8_5=bayesian_8_5, baye_sh1_1_5=bayesian_sh1_1_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh2_1_5=bayesian_sh2_1_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_12=bayesian_12, baye_00=bayesian_00)
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                            ...
                            bayesian_4_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                            bayesian_6_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                            bayesian_8_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_4_5 = 0.5 * (OVER_4_5_S[q] + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                            bayesian_6_5 = 0.5 * (OVER_6_5_S[q] + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                            bayesian_8_5 = 0.5 * (OVER_8_5_S[q] + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                            ...
                            bayesian_4_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + rdm.random())
                            bayesian_6_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + rdm.random())
                            bayesian_8_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + rdm.random())
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_4_5 = 0.5 * (OVER_4_5_S[q] + rdm.random())
                            bayesian_6_5 = 0.5 * (OVER_6_5_S[q] + rdm.random())
                            bayesian_8_5 = 0.5 * (OVER_8_5_S[q] + rdm.random())
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_4_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + OVER_4_5_S[q])
                            bayesian_6_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + OVER_6_5_S[q])
                            bayesian_8_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + OVER_8_5_S[q])
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[1]:
                            ...
                            bayesian_4_5 = rdm.random() * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))
                            bayesian_6_5 = rdm.random() * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))
                            bayesian_8_5 = rdm.random() * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                            ...
                            bayesian_4_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))
                            bayesian_6_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))
                            bayesian_8_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_4_5 = OVER_4_5_S[q] * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))
                            bayesian_6_5 = OVER_6_5_S[q] * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))
                            bayesian_8_5 = OVER_8_5_S[q] * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                            ...
                            bayesian_4_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * rdm.random()
                            bayesian_6_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * rdm.random()
                            bayesian_8_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * rdm.random()
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_4_5 = OVER_4_5_S[q] * rdm.random()
                            bayesian_6_5 = OVER_6_5_S[q] * rdm.random()
                            bayesian_8_5 = OVER_8_5_S[q] * rdm.random()
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_4_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * OVER_4_5_S[q]
                            bayesian_6_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * OVER_6_5_S[q]
                            bayesian_8_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * OVER_8_5_S[q]
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[2]:
                            ...
                            bayesian_4_5 = math.sqrt(0.5 * (rdm.random() + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))))
                            bayesian_6_5 = math.sqrt(0.5 * (rdm.random() + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))))
                            bayesian_8_5 = math.sqrt(0.5 * (rdm.random() + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                            ...
                            bayesian_4_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))))
                            bayesian_6_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))))
                            bayesian_8_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_4_5 = math.sqrt(0.5 * (OVER_4_5_S[q] + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))))
                            bayesian_6_5 = math.sqrt(0.5 * (OVER_6_5_S[q] + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))))
                            bayesian_8_5 = math.sqrt(0.5 * (OVER_8_5_S[q] + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                            ...
                            bayesian_4_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + rdm.random()))
                            bayesian_6_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + rdm.random()))
                            bayesian_8_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + rdm.random()))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_4_5 = math.sqrt(0.5 * (OVER_4_5_S[q] + rdm.random()))
                            bayesian_6_5 = math.sqrt(0.5 * (OVER_6_5_S[q] + rdm.random()))
                            bayesian_8_5 = math.sqrt(0.5 * (OVER_8_5_S[q] + rdm.random()))
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_4_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + OVER_4_5_S[q]))
                            bayesian_6_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + OVER_6_5_S[q]))
                            bayesian_8_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + OVER_8_5_S[q]))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[3]:
                            ...
                            bayesian_4_5 = math.sqrt(rdm.random() * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                            bayesian_6_5 = math.sqrt(rdm.random() * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                            bayesian_8_5 = math.sqrt(rdm.random() * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                            ...
                            bayesian_4_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                            bayesian_6_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                            bayesian_8_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_4_5 = math.sqrt(OVER_4_5_S[q] * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                            bayesian_6_5 = math.sqrt(OVER_6_5_S[q] * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                            bayesian_8_5 = math.sqrt(OVER_8_5_S[q] * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                            ...
                            bayesian_4_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * rdm.random())
                            bayesian_6_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * rdm.random())
                            bayesian_8_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * rdm.random())
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_4_5 = math.sqrt(OVER_4_5_S[q] * rdm.random())
                            bayesian_6_5 = math.sqrt(OVER_6_5_S[q] * rdm.random())
                            bayesian_8_5 = math.sqrt(OVER_8_5_S[q] * rdm.random())
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_4_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * OVER_4_5_S[q])
                            bayesian_6_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * OVER_6_5_S[q])
                            bayesian_8_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * OVER_8_5_S[q])
                ...
                for q in range(len(bayesian_home_Win_d)):
                        ...
                        for i in range(11):
                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_{i}.txt", mode="a") as file:
                                file.write(f"CONFIDENCE INTERVAL - {CONFINTVL}~COUNTRIES|LEAGUES|HOME TEAMS|AWAY TEAMS|HOME POSITIONS|AWAY POSITIONS|HOME NMP|AWAY NMP|"
                                           f"HOME PTS|AWAY PTS|HW FORM|HD FORM|HL FORM|AW FORM|AD FORM|AL FORM|HT_GAVG|AT_GAVG|BTH_GAVG|BTA_GAVG|HT_SCDIFF|AT_SCDIFF|BTH_SCDIFF|BTA_SCDIFF|BAYESIAN {OUTCOMES[0]}|"
                    ...
                    try:
                        if bayesian_4_5_d[q] > CONFINTVL or bayesian_6_5_d[q] > CONFINTVL or bayesian_8_5_d[q] > CONFINTVL or bayesian_sh1_1_5_d[q] > CONFINTVL or bayesian_sh1_2_5_d[q] > CONFINTVL or bayesian_sh2_1_5_d[q] > CONFINTVL or bayesian_sh2_2_5_d[q] > CONFINTVL:
                                ...
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                            if bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                            ...
                                            if bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q] and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                    writer(w=q, A=X, B=Y, C=Z, data=file)
                            ...
                            if (home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP) and (((home_positions[q] <= away_positions[q]) and (bayesian_sh1_1_5_d[q] >= bayesian_sh2_1_5_d[q]) and (bayesian_sh1_2_5_d[q] >= bayesian_sh2_2_5_d[q]) and (bayesian_home_Win_d[q] >= bayesian_away_Win_d[q]) and (home_points[q] >= away_points[q]) and ((h_form_W[q] + h_form_D[q]) >= (a_form_W[q] + a_form_D[q])) and ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q]))) or ((home_positions[q] >= away_positions[q]) and (bayesian_home_Win_d[q] <= bayesian_away_Win_d[q]) and (bayesian_sh2_1_5_d[q] >= bayesian_sh1_1_5_d[q]) and (bayesian_sh2_2_5_d[q] >= bayesian_sh1_2_5_d[q]) and (home_points[q] <= away_points[q]) and ((h_form_W[q] + h_form_D[q]) <= (a_form_W[q] + a_form_D[q])) and ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])))):
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        ...
                                        if bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer(w=q, A=X, B=Y, C=Z, data=file)
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0]:
                        ...
                        bayesian_4_5 = (prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))
                        bayesian_6_5 = (prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))
                        bayesian_8_5 = (prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))
                    ...
                    if X == PROB_METRICS[1]:
                        ...
                        prob_4_5 = rdm.random()
                        prob_4_5_indp_home = rdm.random()
                        prob_4_5_indp_away = rdm.random()
                        bayesian_4_5 = (prob_4_5 * (prob_4_5_indp_home * prob_4_5_indp_away)) / ((prob_4_5 * (prob_4_5_indp_home * prob_4_5_indp_away)) + ((1 - (prob_4_5_indp_home * prob_4_5_indp_away)) * (1 - prob_4_5)))
                        prob_6_5 = rdm.random()
                        prob_6_5_indp_home = rdm.random()
                        prob_6_5_indp_away = rdm.random()
                        bayesian_6_5 = (prob_6_5 * (prob_6_5_indp_home * prob_6_5_indp_away)) / ((prob_6_5 * (prob_6_5_indp_home * prob_6_5_indp_away)) + ((1 - (prob_6_5_indp_home * prob_6_5_indp_away)) * (1 - prob_6_5)))
                        prob_8_5 = rdm.random()
                        prob_8_5_indp_home = rdm.random()
                        prob_8_5_indp_away = rdm.random()
                        bayesian_8_5 = (prob_8_5 * (prob_8_5_indp_home * prob_8_5_indp_away)) / ((prob_8_5 * (prob_8_5_indp_home * prob_8_5_indp_away)) + ((1 - (prob_8_5_indp_home * prob_8_5_indp_away)) * (1 - prob_8_5)))
                    ...
                    if X == PROB_METRICS[2]:
                        ...
                        bayesian_4_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))
                        bayesian_6_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))
                        bayesian_8_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))
                    ...
                    if X == PROB_METRICS[3]:
                        ...
                        bayesian_4_5 = OVER_4_5_S[q]
                        bayesian_6_5 = OVER_6_5_S[q]
                        bayesian_8_5 = OVER_8_5_S[q]
                    ...
                    if X == PROB_METRICS[4]:
                        ...
                        bayesian_4_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q])) * diff_z_prob[q]
                        bayesian_6_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q])) * diff_z_prob[q]
                        bayesian_8_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q])) * diff_z_prob[q]
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[1]:
                        ...
                        prob_4_5_indp_home = rdm.random()
                        prob_4_5_indp_away = rdm.random()
                        bayesian_4_5 = (prob_4_5s[q] * (prob_4_5_indp_home * prob_4_5_indp_away)) / ((prob_4_5s[q] * (prob_4_5_indp_home * prob_4_5_indp_away)) + ((1 - (prob_4_5_indp_home * prob_4_5_indp_away)) * (1 - prob_4_5s[q])))
                        prob_6_5_indp_home = rdm.random()
                        prob_6_5_indp_away = rdm.random()
                        bayesian_6_5 = (prob_6_5s[q] * (prob_6_5_indp_home * prob_6_5_indp_away)) / ((prob_6_5s[q] * (prob_6_5_indp_home * prob_6_5_indp_away)) + ((1 - (prob_6_5_indp_home * prob_6_5_indp_away)) * (1 - prob_6_5s[q])))
                        prob_8_5_indp_home = rdm.random()
                        prob_8_5_indp_away = rdm.random()
                        bayesian_8_5 = (prob_8_5s[q] * (prob_8_5_indp_home * prob_8_5_indp_away)) / ((prob_8_5s[q] * (prob_8_5_indp_home * prob_8_5_indp_away)) + ((1 - (prob_8_5_indp_home * prob_8_5_indp_away)) * (1 - prob_8_5s[q])))
                        prob_sh1_1_5_indp_home = rdm.random()
                        prob_sh1_1_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[2]:
                        ...
                        prob_4_5_indp_home = rdm.random()
                        prob_4_5_indp_away = rdm.random()
                        bayesian_4_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * (prob_4_5_indp_home * prob_4_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * (prob_4_5_indp_home * prob_4_5_indp_away)) + ((1 - (prob_4_5_indp_home * prob_4_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q])))))))
                        prob_6_5_indp_home = rdm.random()
                        prob_6_5_indp_away = rdm.random()
                        bayesian_6_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * (prob_6_5_indp_home * prob_6_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * (prob_6_5_indp_home * prob_6_5_indp_away)) + ((1 - (prob_6_5_indp_home * prob_6_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q])))))))
                        prob_8_5_indp_home = rdm.random()
                        prob_8_5_indp_away = rdm.random()
                        bayesian_8_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * (prob_8_5_indp_home * prob_8_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * (prob_8_5_indp_home * prob_8_5_indp_away)) + ((1 - (prob_8_5_indp_home * prob_8_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q])))))))
                        prob_sh1_1_5_indp_home = rdm.random()
                        prob_sh1_1_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[3]:
                        ...
                        prob_4_5_indp_home = rdm.random()
                        prob_4_5_indp_away = rdm.random()
                        bayesian_4_5 = (OVER_4_5_S[q] * (prob_4_5_indp_home * prob_4_5_indp_away)) / ((OVER_4_5_S[q] * (prob_4_5_indp_home * prob_4_5_indp_away)) + ((1 - (prob_4_5_indp_home * prob_4_5_indp_away)) * (1 - OVER_4_5_S[q])))
                        prob_6_5_indp_home = rdm.random()
                        prob_6_5_indp_away = rdm.random()
                        bayesian_6_5 = (OVER_6_5_S[q] * (prob_6_5_indp_home * prob_6_5_indp_away)) / ((OVER_6_5_S[q] * (prob_6_5_indp_home * prob_6_5_indp_away)) + ((1 - (prob_6_5_indp_home * prob_6_5_indp_away)) * (1 - OVER_6_5_S[q])))
                        prob_8_5_indp_home = rdm.random()
                        prob_8_5_indp_away = rdm.random()
                        bayesian_8_5 = (OVER_8_5_S[q] * (prob_8_5_indp_home * prob_8_5_indp_away)) / ((OVER_8_5_S[q] * (prob_8_5_indp_home * prob_8_5_indp_away)) + ((1 - (prob_8_5_indp_home * prob_8_5_indp_away)) * (1 - OVER_8_5_S[q])))
                        prob_sh1_1_5_indp_home = rdm.random()
                        prob_sh1_1_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[0]:
                        ...
                        prob_4_5 = rdm.random()
                        bayesian_4_5 = ((prob_4_5 * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5 * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5))))
                        prob_6_5 = rdm.random()
                        bayesian_6_5 = ((prob_6_5 * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5 * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5))))
                        prob_8_5 = rdm.random()
                        bayesian_8_5 = ((prob_8_5 * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5 * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5))))
                        prob_sh1_1_5 = rdm.random()
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[2]:
                        ...
                        bayesian_4_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))))))
                        bayesian_6_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))))))
                        bayesian_8_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))))))
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[3]:
                        ...
                        bayesian_4_5 = (OVER_4_5_S[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((OVER_4_5_S[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - OVER_4_5_S[q])))
                        bayesian_6_5 = (OVER_6_5_S[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((OVER_6_5_S[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - OVER_6_5_S[q])))
                        bayesian_8_5 = (OVER_8_5_S[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((OVER_8_5_S[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - OVER_8_5_S[q])))
                    ...
                    for q in range(len(home_teams)):
                        try:
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                                ...
                                bayesian_4_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + rdm.random() + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                                bayesian_6_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + rdm.random() + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                                bayesian_8_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + rdm.random() + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                                ...
                                bayesian_4_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * rdm.random() * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))
                                bayesian_6_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * rdm.random() * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))
                                bayesian_8_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * rdm.random() * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[4]:
                                ...
                                bayesian_4_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + rdm.random() + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))))
                                bayesian_6_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + rdm.random() + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))))
                                bayesian_8_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + rdm.random() + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_4_5 = (1 / 3) * (OVER_4_5_S[q] + rdm.random() + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                                bayesian_6_5 = (1 / 3) * (OVER_6_5_S[q] + rdm.random() + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                                bayesian_8_5 = (1 / 3) * (OVER_8_5_S[q] + rdm.random() + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_4_5 = OVER_4_5_S[q] * rdm.random() * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))
                                bayesian_6_5 = OVER_6_5_S[q] * rdm.random() * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))
                                bayesian_8_5 = OVER_8_5_S[q] * rdm.random() * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_4_5 = np.cbrt((1 / 3) * (OVER_4_5_S[q] + rdm.random() + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))))
                                bayesian_6_5 = np.cbrt((1 / 3) * (OVER_6_5_S[q] + rdm.random() + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))))
                                bayesian_8_5 = np.cbrt((1 / 3) * (OVER_8_5_S[q] + rdm.random() + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_4_5 = np.cbrt(OVER_4_5_S[q] * rdm.random() * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                                bayesian_6_5 = np.cbrt(OVER_6_5_S[q] * rdm.random() * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                                bayesian_8_5 = np.cbrt(OVER_8_5_S[q] * rdm.random() * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_4_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + OVER_4_5_S[q] + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                                bayesian_6_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + OVER_6_5_S[q] + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                                bayesian_8_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + OVER_8_5_S[q] + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_4_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * OVER_4_5_S[q] * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))
                                bayesian_6_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * OVER_6_5_S[q] * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))
                                bayesian_8_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * OVER_8_5_S[q] * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_4_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + OVER_4_5_S[q] + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))))
                                bayesian_6_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + OVER_6_5_S[q] + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))))
                                bayesian_8_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + OVER_8_5_S[q] + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_4_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * OVER_4_5_S[q] * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                                bayesian_6_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * OVER_6_5_S[q] * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                                bayesian_8_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * OVER_8_5_S[q] * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_4_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + rdm.random() + OVER_4_5_S[q])
                                bayesian_6_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + rdm.random() + OVER_6_5_S[q])
                                bayesian_8_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + rdm.random() + OVER_8_5_S[q])
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_4_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * rdm.random() * OVER_4_5_S[q]
                                bayesian_6_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * rdm.random() * OVER_6_5_S[q]
                                bayesian_8_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * rdm.random() * OVER_8_5_S[q]
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_4_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + rdm.random() + OVER_4_5_S[q]))
                                bayesian_6_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + rdm.random() + OVER_6_5_S[q]))
                                bayesian_8_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + rdm.random() + OVER_8_5_S[q]))
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_4_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * rdm.random() * OVER_4_5_S[q])
                                bayesian_6_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * rdm.random() * OVER_6_5_S[q])
                                bayesian_8_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * rdm.random() * OVER_8_5_S[q])
                                    ...
                                    if h_form_D[q] == 0 and a_form_D[q] == 0:
                                        if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                            if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                                if bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                    if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                        with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                            writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                            else:
                                                if bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                ...
                                if (home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP) and (((home_positions[q] <= away_positions[q]) and (bayesian_sh1_1_5_d[q] >= bayesian_sh2_1_5_d[q]) and (bayesian_sh1_2_5_d[q] >= bayesian_sh2_2_5_d[q]) and (bayesian_home_Win_d[q] >= bayesian_away_Win_d[q]) and (home_points[q] >= away_points[q]) and ((h_form_W[q] + h_form_D[q]) >= (a_form_W[q] + a_form_D[q])) and ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q]))) or ((home_positions[q] >= away_positions[q]) and (bayesian_home_Win_d[q] <= bayesian_away_Win_d[q]) and (bayesian_sh2_1_5_d[q] >= bayesian_sh1_1_5_d[q]) and (bayesian_sh2_2_5_d[q] >= bayesian_sh1_2_5_d[q]) and (home_points[q] <= away_points[q]) and ((h_form_W[q] + h_form_D[q]) <= (a_form_W[q] + a_form_D[q])) and ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])))):
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            ...
                                            if bayesian_8_5_d[q] <= bayesian_6_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                    ...
                    for q in range(len(home_teams)):
                        try:
                            if Z == COMBINERS[0]:
                                ...
                                bayesian_4_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + rdm.random() + OVER_4_5_S[q] + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))
                                bayesian_6_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + rdm.random() + OVER_6_5_S[q] + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))
                                bayesian_8_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + rdm.random() + OVER_8_5_S[q] + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))
                            ...
                            if Z == COMBINERS[1]:
                                ...
                                bayesian_4_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * rdm.random() * OVER_4_5_S[q] * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))
                                bayesian_6_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * rdm.random() * OVER_6_5_S[q] * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))
                                bayesian_8_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * rdm.random() * OVER_8_5_S[q] * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))
                            ...
                            if Z == COMBINERS[6]:
                                ...
                                bayesian_4_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) + rdm.random() + OVER_4_5_S[q] + ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q])))))) ** 0.25
                                bayesian_6_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) + rdm.random() + OVER_6_5_S[q] + ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q])))))) ** 0.25
                                bayesian_8_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) + rdm.random() + OVER_8_5_S[q] + ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q])))))) ** 0.25
                            ...
                            if Z == COMBINERS[7]:
                                ...
                                bayesian_4_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_4_5s[q]))) * rdm.random() * OVER_4_5_S[q] * ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) / ((prob_4_5s[q] * (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) + ((1 - (prob_4_5_H_indps[q] * prob_4_5_A_indps[q])) * (1 - prob_4_5s[q]))))) ** 0.25
                                bayesian_6_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_6_5s[q]))) * rdm.random() * OVER_6_5_S[q] * ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) / ((prob_6_5s[q] * (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) + ((1 - (prob_6_5_H_indps[q] * prob_6_5_A_indps[q])) * (1 - prob_6_5s[q]))))) ** 0.25
                                bayesian_8_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_8_5s[q]))) * rdm.random() * OVER_8_5_S[q] * ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) / ((prob_8_5s[q] * (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) + ((1 - (prob_8_5_H_indps[q] * prob_8_5_A_indps[q])) * (1 - prob_8_5s[q]))))) ** 0.25
