...
OUTCOMES = ["HW", "AW", "ov4.5", "ov5.5", "ov6.5", "sh1_1.5", "sh1_2.5", "sh2_1.5", "sh2_2.5", "12"]
OUTCOMES_ALT_XLR = ["HW", "AW", "12"]

start_time = time.time()
SPORT_ = master_sport_list()[0][10]

chrome_path = CRITERIA[21][4]
...
def team_data(frame_):
    country = driver.find_element(By.CSS_SELECTOR, '.tournamentHeaderDescription .tournamentHeader__country').text.split(':')[0]
    league = f"{driver.find_element(By.CSS_SELECTOR, '.tournamentHeaderDescription .tournamentHeader__country').text.split(':')[1].split(' - ')[0]} - {frame_}"
    try:
...
def ht_g_diff_avg_aggregator():
    ...
    if len(date_) > 0:
        ...
        try:
            ...
            ht_g_diff_avgs.append(round(rdm.uniform(-5, 5), 2))
    else:
        ht_g_diff_avgs.append(round(rdm.uniform(-5, 5), 2))
...
def at_g_diff_avg_aggregator():
    ...
    if len(date__) > 0:
        ...
        try:
            ...
            at_g_diff_avgs.append(round(rdm.uniform(-5, 5), 2))
    else:
        at_g_diff_avgs.append(round(rdm.uniform(-5, 5), 2))
...
def bt_g_diff_avg_aggregator():
    ...
    if len(date___) > 0:
        ...
        try:
            ...
            bth_g_diff_avgs_x = round(rdm.uniform(-5, 5), 2)
...
def ht_g_avg_aggregator():
    ...
    if len(date_) > 0:
        ...
        try:
            ...
            ht_g_avgs.append(round(rdm.uniform(0, 7), 2))
    else:
        ht_g_avgs.append(round(rdm.uniform(0, 7), 2))
...
def at_g_avg_aggregator():
    ...
    if len(date__) > 0:
        ...
        try:
            ...
            at_g_avgs.append(round(rdm.uniform(0, 7), 2))
    else:
        at_g_avgs.append(round(rdm.uniform(0, 7), 2))
...
def bt_g_avg_aggregator():
    ...
    if len(date___) > 0:
        ...
        try:
            ...
            bth_g_avgs.append(round(rdm.uniform(0, 7), 2))
            bta_g_avgs.append(round(rdm.uniform(0, 7), 2))
    else:
        bth_g_avgs.append(round(rdm.uniform(0, 7), 2))
        bta_g_avgs.append(round(rdm.uniform(0, 7), 2))
...
def h2h_aggregator():
            ...
            try:
                if YEAR <= int(date___[m].text.split('.')[-1].strip()) < 90:
                    ...
                    if (int(home_score[m].text) + int(away_score[m].text)) >= 5:
                        count_4_5 += 1
                    if (int(home_score[m].text) + int(away_score[m].text)) >= 6:
                        count_5_5 += 1
    ...
    return [valid_games, count_HW, count_AW, count_4_5, count_5_5, count_6_5, count_sh1_1_5, count_sh1_2_5, count_sh2_1_5, count_sh2_2_5, count_12]


def h2h_prob_calc(h2h_probz):
    prob_HW = float(h2h_probz[1] / h2h_probz[0])
    prob_AW = float(h2h_probz[2] / h2h_probz[0])
    prob_4_5i = float(h2h_probz[3] / h2h_probz[0])
    prob_5_5i = float(h2h_probz[4] / h2h_probz[0])
    ...
    h2h_probs = [prob_HW, prob_AW, prob_4_5i, prob_5_5i, prob_6_5i, prob_sh1_1_5i, prob_sh1_2_5i, prob_sh2_1_5i, prob_sh2_2_5i, prob_12i]
    probs_H2H = []
    ...
    return [probs_H2H[0], probs_H2H[1], probs_H2H[2], probs_H2H[3], probs_H2H[4], probs_H2H[5], probs_H2H[6], probs_H2H[7], probs_H2H[8], probs_H2H[8]]


def h2h_appender(prb_HW, prb_AW, prb_4_5, prb_5_5, prb_6_5, prb_sh1_1_5, prb_sh1_2_5, prb_sh2_1_5, prb_sh2_2_5, prb_12):
    prob_HWs.append(prb_HW)
    prob_AWs.append(prb_AW)
    prob_4_5s.append(prb_4_5)
    prob_5_5s.append(prb_5_5)
...
def ht_indp_aggregator():
            ...
            try:
                if YEAR <= int(date_[k].text.split('.')[-1].strip()) < 90:
                    ...
                    if int(home_score[k].text) == int(away_score[k].text):
                        count_HW_H_indp += 0
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 5 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 2:
                        count_4_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 5 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 2:
                        count_4_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 6 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 3:
                        count_5_5_H_indp += 1
                    if (int(home_score[k].text) + int(away_score[k].text)) >= 6 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 3:
                        count_5_5_H_indp += 1
    ...
    return [valid_games_H_indp, count_HW_H_indp, count_4_5_H_indp, count_5_5_H_indp, count_6_5_H_indp, count_sh1_1_5_H_indp, count_sh1_2_5_H_indp, count_12_H_indp]


def ht_indp_prob_calc(ht_probz):
    prob_HW_H_indp = float(ht_probz[1] / ht_probz[0])
    prob_AW_H_indp = 1 - prob_HW_H_indp
    prob_4_5_H_indp = float(ht_probz[2] / ht_probz[0])
    prob_5_5_H_indp = float(ht_probz[3] / ht_probz[0])
    ...
    ht_indp_probs = [prob_HW_H_indp, prob_AW_H_indp, prob_4_5_H_indp, prob_5_5_H_indp, prob_6_5_H_indp, prob_sh1_1_5_H_indp,
...
def ht_indp_appender(prb_HW_H_indp, prb_AW_H_indp, prb_4_5_H_indp, prb_5_5_H_indp, prb_6_5_H_indp, prb_sh1_1_5_H_indp,
    ...
    prob_5_5_H_indps.append(prb_5_5_H_indp)
...
def at_indp_aggregator():
            ...
            try:
                if YEAR <= int(date__[n].text.split('.')[-1].strip()) < 90:
                    ...
                    if int(home_score[n].text) == int(away_score[n].text):
                        count_AW_A_indp += 0
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 5 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 2:
                        count_4_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 5 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 2:
                        count_4_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 6 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 3:
                        count_5_5_A_indp += 1
                    if (int(home_score[n].text) + int(away_score[n].text)) >= 6 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 3:
                        count_5_5_A_indp += 1
    ...
    return [valid_games_A_indp, count_AW_A_indp, count_4_5_A_indp, count_5_5_A_indp, count_6_5_A_indp, count_sh2_1_5_A_indp, count_sh2_2_5_A_indp, count_12_A_indp]


def at_indp_prob_calc(at_probz):
    prob_AW_A_indp = float(at_probz[1] / at_probz[0])
    prob_HW_A_indp = 1 - prob_AW_A_indp
    prob_4_5_A_indp = float(at_probz[2] / at_probz[0])
    prob_5_5_A_indp = float(at_probz[2] / at_probz[0])
    prob_6_5_A_indp = float(at_probz[3] / at_probz[0])
    ...
    at_indp_probs = [prob_HW_A_indp, prob_AW_A_indp, prob_4_5_A_indp, prob_5_5_A_indp, prob_6_5_A_indp, prob_sh1_1_5_A_indp,
...
def at_indp_appender(prb_HW_A_indp, prb_AW_A_indp, prb_4_5_A_indp, prb_5_5_A_indp, prb_6_5_A_indp, prb_sh1_1_5_A_indp,
    ...
    prob_5_5_A_indps.append(prb_5_5_A_indp)
...
def data_break_zeroes1(home_pos_, away_pos_, z, ent1):
    h2h_appender(prb_HW=rdm.random(), prb_AW=rdm.random(), prb_4_5=rdm.random(), prb_5_5=rdm.random(), prb_6_5=rdm.random(), prb_sh1_1_5=rdm.random(),
                 prb_sh1_2_5=rdm.random(), prb_sh2_1_5=rdm.random(), prb_sh2_2_5=rdm.random(), prb_12=rdm.random())

    ht_indp_appender(prb_HW_H_indp=rdm.random(), prb_AW_H_indp=rdm.random(), prb_4_5_H_indp=rdm.random(), prb_5_5_H_indp=rdm.random(), prb_6_5_H_indp=rdm.random(),
                     prb_sh1_1_5_H_indp=rdm.random(), prb_sh1_2_5_H_indp=rdm.random(),
                     prb_sh2_1_5_H_indp=rdm.random(), prb_sh2_2_5_H_indp=rdm.random(), prb_12_H_indp=rdm.random())

    at_indp_appender(prb_HW_A_indp=rdm.random(), prb_AW_A_indp=rdm.random(), prb_4_5_A_indp=rdm.random(), prb_5_5_A_indp=rdm.random(), prb_6_5_A_indp=rdm.random(),
                     prb_sh1_1_5_A_indp=rdm.random(), prb_sh1_2_5_A_indp=rdm.random(),
                     prb_sh2_1_5_A_indp=rdm.random(), prb_sh2_2_5_A_indp=rdm.random(), prb_12_A_indp=rdm.random())
...
def odds_checker():
    def odds_augment(odds_home, odds_away):
        ...
        try:
            ...
            if 0 < home_aug_odd < 1 and 0 < away_aug_odd < 1:
                _1HWS.append(home_aug_odd)
                _2AWS.append(away_aug_odd)
            else:
                home_aug_odd = rdm.random()
                away_aug_odd = 1 - home_aug_odd
                odds_diff = abs(home_aug_odd - away_aug_odd)
    ...
    try:
        ...
        try:
            ...
            for x in range(len(ahl)):
                try:
                    id_5_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_5_5 == "5.5":
                        OVER_5_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_5_5_S.append(1 / float(OVER_5_5))
                        break
                    if x == (len(ahl) - 1):
                        OVER_5_5_S.append(rdm.random())
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_5_5_S.append(rdm.random())
            for z in range(len(ahl)):
                try:
                    id_6_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_6_5 == "6.5":
                        OVER_6_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
            ...
            if odds_diff_ < CLEARANCE__:
                ...
                if odds_diff_ < CLEARANCE__:
                    ...
                    if odds_diff_ < CLEARANCE__:
                        ...
                        away_aug_odd_ = 1 - home_aug_odd_
        _1HWS.append(home_aug_odd_)
        _2AWS.append(away_aug_odd_)
        OVER_4_5_S.append(rdm.random())
        OVER_5_5_S.append(rdm.random())
        OVER_6_5_S.append(rdm.random())
        OVER_sh1_1_5_S.append(rdm.random())
...
def writer(w, A, B, C, data):
    data.write(f"{countries[w]}|{leagues[w]}|{home_teams[w]}|{away_teams[w]}|{home_positions[w]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_4_5_d[w]}|{OUTCOMES[3]}:-{bayesian_5_5_d[w]}|"
               f"{OUTCOMES[4]}:-{bayesian_6_5_d[w]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[w]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[w]}|"
...
def writer1(y, F, G, H, J, data):
    data.write(f"{countries[y]}|{leagues[y]}|{home_teams[y]}|{away_teams[y]}|{home_positions[y]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_4_5_d[y]}|{OUTCOMES[3]}:-{bayesian_5_5_d[y]}|"
               f"{OUTCOMES[4]}:-{bayesian_6_5_d[y]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[y]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[y]}|"
...
def writer2(z, K, L, M, N, P, data):
    data.write(f"{countries[z]}|{leagues[z]}|{home_teams[z]}|{away_teams[z]}|{home_positions[z]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_4_5_d[z]}|{OUTCOMES[3]}:-{bayesian_5_5_d[z]}|"
               f"{OUTCOMES[4]}:-{bayesian_6_5_d[z]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[z]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[z]}|"
...
def baye_appender(baye_HW, baye_AW, baye_4_5, baye_5_5, baye_6_5, baye_sh1_1_5, baye_sh1_2_5, baye_sh2_1_5,
                  baye_sh2_2_5, baye_12):
    ...
    bayesian_5_5_d.append(round((float(baye_5_5)), 4))
...
def total_aggregator():
            ...
            if ht_probs[0] >= DSCRM_H_A:
                try:
                    ...
                    ht_indp_appender(prb_HW_H_indp=ht_indp_values[0], prb_AW_H_indp=ht_indp_values[1],
                                     prb_4_5_H_indp=ht_indp_values[2], prb_5_5_H_indp=ht_indp_values[3],
                                     prb_6_5_H_indp=ht_indp_values[4], prb_sh1_1_5_H_indp=ht_indp_values[5],
    ...
    try:
        ...
        if len(sub2) < DSCRM_H_A:
            at_indp_zero()
            at_g_avgs.append(round(rdm.uniform(0, 7)))
            at_g_diff_avgs.append(round(rdm.uniform(-5, 5), 2))
        else:
            ...
            if at_probs[0] >= DSCRM_H_A:
                try:
                    ...
                    at_indp_appender(prb_HW_A_indp=at_indp_values[0], prb_AW_A_indp=at_indp_values[1],
                                     prb_4_5_A_indp=at_indp_values[2], prb_5_5_A_indp=at_indp_values[3],
                                     prb_6_5_A_indp=at_indp_values[4], prb_sh1_1_5_A_indp=at_indp_values[5],
        ...
        if len(sub3) < DSCRM_BT:
            ...
            if h2h_probs[0] >= DSCRM_BT:
                try:
                    ...
                    h2h_appender(prb_HW=h2h_values[0], prb_AW=h2h_values[1], prb_4_5=h2h_values[2], prb_5_5=h2h_values[3],
                                 prb_6_5=h2h_values[4], prb_sh1_1_5=h2h_values[5], prb_sh1_2_5=h2h_values[6],
                                 prb_sh2_1_5=h2h_values[7], prb_sh2_2_5=h2h_values[8], prb_12=h2h_values[9])
                except ZeroDivisionError:
                    h2h_zero()
            else:
                h2h_zero()
...
def print_all_data():
    print(f"Countries: {len(countries)}, Leagues: {len(leagues)}, Home Teams: {len(home_teams)}, "
          ...
          f"Prob 4_5s: {len(prob_4_5s)}, Prob 5_5s: {len(prob_5_5s)} Prob 6_5s: {len(prob_6_5s)}, Prob 5_5s: {len(prob_sh1_1_5s)},"
          f"Prob 12s: {len(prob_12s)}, Prob HWs: {len(prob_HWs)}, Prob AWs: {len(prob_AWs)}, "
          f"Prob 4_5_H_indps: {len(prob_4_5_H_indps)}, Prob 5_5_H_indps: {len(prob_5_5_H_indps)}, Prob 6_5_H_indps: {len(prob_6_5_H_indps)}, "
          f"Prob 5_5_H_indps: {len(prob_sh1_1_5_H_indps)}, Prob 12_H_indps: {len(prob_12_H_indps)},"
          f"Prob HW_H_indps: {len(prob_HW_H_indps)}, Prob AW_H_indps: {len(prob_AW_H_indps)}, "
          f"Prob 4_5_A_indps: {len(prob_4_5_A_indps)}, Prob 5_5_A_indps: {len(prob_5_5_A_indps)}, Prob 6_5_A_indps: {len(prob_6_5_A_indps)}, "
          ...
          f"Odds _1HWS: {len(_1HWS)}, Odds _2AWS: {len(_2AWS)}, Odds OVER_4_5_S: {len(OVER_5_5_S)},  Odds OVER_5_5_S: {len(OVER_5_5_S)}, "
          f"Odds OVER_6_5_S: {len(OVER_6_5_S)}, Odds OVER_sh1_1_5_S: {len(OVER_sh1_1_5_S)}, Odds _12S: {len(_12S)}"
          f"Bayesian Home Win: {len(bayesian_home_Win_d)}, Bayesian Away Win: {len(bayesian_away_Win_d)}, "
          f"Bayesian 4_5: {len(bayesian_4_5_d)}, Bayesian 5.5: {len(bayesian_5_5_d)}, Bayesian 6.5: {len(bayesian_6_5_d)}, "
...
try:
    sub_m_t = []
    frames_t = []
    frames = driver.find_elements(By.CLASS_NAME, 'event__frames')
    match_timez = driver.find_elements(By.CLASS_NAME, 'event__time')
    for m_t in range(len(match_timez)):
        frames_t.append(frames[m_t].text.split('\n')[0])
        ...
        with open(f"../LISTS - SPORTS DATA/SPORTS_DATA_LIST_{sport}.txt", mode="w") as file:
            try:
                file.write(f"countries = {countries}\nleagues = {leagues}\nhome_teams = {home_teams}\n"
                           ...
                           f"prob_4_5_A_indps = {prob_4_5_A_indps}\nprob_5_5_A_indps = {prob_5_5_A_indps}\nprob_6_5_A_indps = {prob_6_5_A_indps}\n"
        ...
        for COMBINER in COMBINERS[:4]:
            ...
            for COMB in COMB_PROB_METRICS1:
                ...
                for q in range(len(home_teams)):
                    try:
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                            ...
                            bayesian_5_5 = 0.5 * (rdm.random() + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                            ...
                            baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_4_5=bayesian_4_5, baye_5_5=bayesian_5_5, baye_6_5=bayesian_6_5, baye_sh1_1_5=bayesian_sh1_1_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh2_1_5=bayesian_sh2_1_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_12=bayesian_12)
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                            ...
                            bayesian_5_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_5_5 = 0.5 * (OVER_5_5_S[q] + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                            ...
                            bayesian_5_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + rdm.random())
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_5_5 = 0.5 * (OVER_5_5_S[q] + rdm.random())
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_5_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + OVER_5_5_S[q])
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[1]:
                            ...
                            bayesian_5_5 = rdm.random() * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                            ...
                            bayesian_5_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_5_5 = OVER_5_5_S[q] * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                            ...
                            bayesian_5_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * rdm.random()
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_5_5 = OVER_5_5_S[q] * rdm.random()
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_5_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * OVER_5_5_S[q]
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[2]:
                            ...
                            bayesian_5_5 = math.sqrt(0.5 * (rdm.random() + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                            ...
                            bayesian_5_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_5_5 = math.sqrt(0.5 * (OVER_5_5_S[q] + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                            ...
                            bayesian_5_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + rdm.random()))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_5_5 = math.sqrt(0.5 * (OVER_5_5_S[q] + rdm.random()))
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                            ...
                            bayesian_5_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + OVER_5_5_S[q]))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[3]:
                            ...
                            bayesian_5_5 = math.sqrt(rdm.random() * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                            ...
                            bayesian_5_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                        ...
                        if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_5_5 = math.sqrt(OVER_5_5_S[q] * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                            ...
                            bayesian_5_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * rdm.random())
                        ...
                        if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_5_5 = math.sqrt(OVER_5_5_S[q] * rdm.random())
                        ...
                        if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                            ...
                            bayesian_5_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * OVER_5_5_S[q])
                ...
                for q in range(len(bayesian_home_Win_d)):
                    ...
                    try:
                        if bayesian_4_5_d[q] > CONFINTVL or bayesian_5_5_d[q] > CONFINTVL or bayesian_6_5_d[q] > CONFINTVL or bayesian_sh1_1_5_d[q] > CONFINTVL or bayesian_sh2_1_5_d[q] > CONFINTVL:
                            if (home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP) and (((home_positions[q] <= away_positions[q]) and (bayesian_home_Win_d[q] >= bayesian_away_Win_d[q]) and ((h_form_W[q] + h_form_D[q]) >= (a_form_W[q] + a_form_D[q]))) or ((home_positions[q] >= away_positions[q]) and (bayesian_home_Win_d[q] <= bayesian_away_Win_d[q]) and ((h_form_W[q] + h_form_D[q]) <= (a_form_W[q] + a_form_D[q])))):
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                            if bayesian_6_5_d[q] <= bayesian_5_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[0]:
                                                    with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer(w=q, A=X, B=Y, C=Z, data=file)
                                        else:
                                            if bayesian_6_5_d[q] <= bayesian_5_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q]:
                                                if ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q])) or ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                    with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer(w=q, A=X, B=Y, C=Z, data=file)
                            ...
                            if (home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP) and (((home_positions[q] <= away_positions[q]) and (bayesian_home_Win_d[q] >= bayesian_away_Win_d[q]) and ((h_form_W[q] + h_form_D[q]) >= (a_form_W[q] + a_form_D[q]))) or ((home_positions[q] >= away_positions[q]) and (bayesian_home_Win_d[q] <= bayesian_away_Win_d[q]) and ((h_form_W[q] + h_form_D[q]) <= (a_form_W[q] + a_form_D[q])))):
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        ...
                                        if bayesian_6_5_d[q] <= bayesian_5_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[0]:
                                                with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer(w=q, A=X, B=Y, C=Z, data=file)
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0]:
                        ...
                        bayesian_5_5 = (prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))
                    ...
                    if X == PROB_METRICS[1]:
                        ...
                        prob_5_5 = rdm.random()
                        prob_5_5_indp_home = rdm.random()
                        prob_5_5_indp_away = rdm.random()
                        bayesian_5_5 = (prob_5_5 * (prob_5_5_indp_home * prob_5_5_indp_away)) / ((prob_5_5 * (prob_5_5_indp_home * prob_5_5_indp_away)) + ((1 - (prob_5_5_indp_home * prob_5_5_indp_away)) * (1 - prob_5_5)))
                        prob_6_5 = rdm.random()
                    ...
                    if X == PROB_METRICS[2]:
                        ...
                        bayesian_5_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))
                    ...
                    if X == PROB_METRICS[4]:
                        ...
                        bayesian_5_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q])) * diff_z_prob[q]
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[1]:
                        ...
                        prob_5_5_indp_home = rdm.random()
                        prob_5_5_indp_away = rdm.random()
                        bayesian_5_5 = (prob_5_5s[q] * (prob_5_5_indp_home * prob_5_5_indp_away)) / ((prob_5_5s[q] * (prob_5_5_indp_home * prob_5_5_indp_away)) + ((1 - (prob_5_5_indp_home * prob_5_5_indp_away)) * (1 - prob_5_5s[q])))
                        prob_6_5_indp_home = rdm.random()
                        prob_6_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[2]:
                        ...
                        prob_5_5_indp_home = rdm.random()
                        prob_5_5_indp_away = rdm.random()
                        bayesian_5_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * (prob_5_5_indp_home * prob_5_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * (prob_5_5_indp_home * prob_5_5_indp_away)) + ((1 - (prob_5_5_indp_home * prob_5_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q])))))))
                        prob_6_5_indp_home = rdm.random()
                        prob_6_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[0] and Y == PROB_METRICS1[3]:
                        ...
                        prob_5_5_indp_home = rdm.random()
                        prob_5_5_indp_away = rdm.random()
                        bayesian_5_5 = (OVER_5_5_S[q] * (prob_5_5_indp_home * prob_5_5_indp_away)) / ((OVER_5_5_S[q] * (prob_5_5_indp_home * prob_5_5_indp_away)) + ((1 - (prob_5_5_indp_home * prob_5_5_indp_away)) * (1 - OVER_5_5_S[q])))
                        prob_6_5_indp_home = rdm.random()
                        prob_6_5_indp_away = rdm.random()
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[0]:
                        ...
                        prob_5_5 = rdm.random()
                        bayesian_5_5 = ((prob_5_5 * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5 * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5))))
                        prob_6_5 = rdm.random()
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[2]:
                        ...
                        bayesian_5_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))))))
                    ...
                    if X == PROB_METRICS1[1] and Y == PROB_METRICS1[3]:
                        ...
                        bayesian_5_5 = (OVER_5_5_S[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((OVER_5_5_S[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - OVER_5_5_S[q])))
                    ...
                    for q in range(len(home_teams)):
                        try:
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                                ...
                                bayesian_5_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + rdm.random() + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                                ...
                                bayesian_5_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * rdm.random() * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[4]:
                                ...
                                bayesian_5_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + rdm.random() + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_5_5 = (1 / 3) * (OVER_5_5_S[q] + rdm.random() + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_5_5 = OVER_5_5_S[q] * rdm.random() * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_5_5 = np.cbrt((1 / 3) * (OVER_5_5_S[q] + rdm.random() + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_5_5 = np.cbrt(OVER_5_5_S[q] * rdm.random() * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_5_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + OVER_5_5_S[q] + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_5_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * OVER_5_5_S[q] * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_5_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + OVER_5_5_S[q] + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))))
                            ...
                            if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_5_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * OVER_5_5_S[q] * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                                ...
                                bayesian_5_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + rdm.random() + OVER_5_5_S[q])
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                                ...
                                bayesian_5_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * rdm.random() * OVER_5_5_S[q]
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                                ...
                                bayesian_5_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + rdm.random() + OVER_5_5_S[q]))
                            ...
                            if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                                ...
                                bayesian_5_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * rdm.random() * OVER_5_5_S[q])
                                    ...
                                    if h_form_D[q] == 0 and a_form_D[q] == 0:
                                        if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                            if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                                if bayesian_6_5_d[q] <= bayesian_5_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                    if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[0]:
                                                        with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                            writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                            else:
                                                if bayesian_6_5_d[q] <= bayesian_5_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                    if ((ht_g_avgs[q] >= at_g_avgs[q]) and (bth_g_avgs[q] >= bta_g_avgs[q]) and (ht_g_diff_avgs[q] >= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] >= bta_g_diff_avgs[q])) or ((ht_g_avgs[q] <= at_g_avgs[q]) and (bth_g_avgs[q] <= bta_g_avgs[q]) and (ht_g_diff_avgs[q] <= at_g_diff_avgs[q]) and (bth_g_diff_avgs[q] <= bta_g_diff_avgs[q])) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                        with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                            writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                ...
                                if (home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP) and (((home_positions[q] <= away_positions[q]) and (bayesian_home_Win_d[q] >= bayesian_away_Win_d[q]) and ((h_form_W[q] + h_form_D[q]) >= (a_form_W[q] + a_form_D[q]))) or ((home_positions[q] >= away_positions[q]) and (bayesian_home_Win_d[q] <= bayesian_away_Win_d[q]) and ((h_form_W[q] + h_form_D[q]) <= (a_form_W[q] + a_form_D[q])))):
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            ...
                                            if bayesian_6_5_d[q] <= bayesian_5_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[0]:
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                    ...
                    for q in range(len(home_teams)):
                        try:
                            if Z == COMBINERS[0]:
                                ...
                                bayesian_5_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + rdm.random() + OVER_5_5_S[q] + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))
                            ...
                            if Z == COMBINERS[1]:
                                ...
                                bayesian_5_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * rdm.random() * OVER_5_5_S[q] * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))
                            ...
                            if Z == COMBINERS[6]:
                                ...
                                bayesian_5_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) + rdm.random() + OVER_5_5_S[q] + ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q])))))) ** 0.25
                            ...
                            if Z == COMBINERS[7]:
                                ...
                                bayesian_5_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_5_5s[q]))) * rdm.random() * OVER_5_5_S[q] * ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) / ((prob_5_5s[q] * (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) + ((1 - (prob_5_5_H_indps[q] * prob_5_5_A_indps[q])) * (1 - prob_5_5s[q]))))) ** 0.25
